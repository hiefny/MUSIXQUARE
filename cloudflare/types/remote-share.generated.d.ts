/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.remote-share.toml --env-interface=MusixquareRemoteShareEnv cloudflare/types/remote-share.generated.d.ts` (hash: d8b4c1f5bff32c42d2a7d68d4a199a1b)
// Runtime types generated with workerd@1.20260722.1 2026-05-03 
interface __BaseEnv_MusixquareRemoteShareEnv {
	REMOTE_SHARE_BUCKET: R2Bucket;
	...
	ALLOWED_ORIGINS: "https://musixquare.com,https://www.musixquare.com,https://musixquare.apps.tossmini.com,https://musixquare.private-apps.tossmini.com,http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173";
	REMOTE_SHARE_QUOTA: DurableObjectNamespace<import("../remote-share-worker").RemoteShareQuota>;
	MUSIXQUARE_SERVICE_CONTROL: DurableObjectNamespace /* MusixquareServiceControl from musixquare-pro-room */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../remote-share-worker");
		durableNamespaces: "RemoteShareQuota";
	}
	interface Env extends __BaseEnv_MusixquareRemoteShareEnv {}
}
interface MusixquareRemoteShareEnv extends __BaseEnv_MusixquareRemoteShareEnv {}
