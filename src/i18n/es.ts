...
const es: Record<I18nKey, string> = {
  ...
  'setup.enter_host_code_alt': 'Escanea el código QR o introduce el código de invitación.',
  ...
  'setup.connect_devices': 'Escanea el QR en otro dispositivo o introduce el código.',
