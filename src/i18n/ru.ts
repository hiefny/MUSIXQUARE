...
const ru: Record<I18nKey, string> = {
  ...
  'account.stats_listening_label': 'Время совместного прослушивания',
  'account.stats_tracks_label': 'Воспроизведённые треки',
  ...
  'pro.request_new_link': 'Запросить новую ссылку',
  'pro.claim_unavailable_title': 'Эту ссылку больше нельзя использовать',
  'pro.new_link_message':
    'Попросите отправителя ссылки предоставить новую ссылку активации или восстановления.',
  ...
  'pro.use_this_tab': 'Перехватить',
  'pro.uploading': 'Сохранение в PRO-комнате...',
  'pro.upload.waiting': 'Ожидание загрузки...',
  'pro.upload.progress': 'Загрузка · {{percent}}%',
  'pro.upload.confirming': 'Подтверждение в PRO-комнате...',
  'pro.upload.completed': 'Добавлено в плейлист',
  'pro.upload.failed': 'Не удалось загрузить',
  'pro.upload.retry': 'Повторить',
  'pro.upload.remove': 'Удалить',
  'pro.upload.cancel_file': 'Отменить загрузку {{name}}',
  'pro.upload.retry_file': 'Повторить загрузку {{name}}',
  'pro.upload.remove_file': 'Удалить неудачную загрузку {{name}}',
  ...
  'chat.tracks_added': '{{name}} добавил(а) {{count}} треков',
