...
const ru: Record<I18nKey, string> = {
  ...
  'app.search_description':
    'Превратите телефоны, планшеты и компьютеры в единую синхронизированную беспроводную аудиосистему. Вместе воспроизводите музыку, видео с YouTube и системный звук прямо в браузере, без установки.',
  ...
  'settings.help_translate': 'Помочь с переводом',
  ...
  'setup.enter_host_code': 'Введите код приглашения',
  'setup.enter_host_code_alt': 'Отсканируйте QR-код или введите код.',
  'setup.scan_qr': 'Нажмите, чтобы сканировать',
  ...
  'toast.system_audio_owner_required':
    'Транслировать аудио можно только из вкладки, в которой была создана комната.',
