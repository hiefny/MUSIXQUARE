...
const es: Record<I18nKey, string> = {
  ...
  'pro.upload.waiting': 'Carga en espera...',
  'pro.upload.progress': 'Subiendo · {{percent}} %',
  'pro.upload.confirming': 'Confirmando en la sala PRO...',
  'pro.upload.completed': 'Añadido a la lista',
  'pro.upload.failed': 'Error de carga',
  'pro.upload.retry': 'Reintentar',
  'pro.upload.remove': 'Quitar',
  'pro.upload.cancel_file': 'Cancelar la carga de {{name}}',
  'pro.upload.retry_file': 'Reintentar la carga de {{name}}',
  'pro.upload.remove_file': 'Quitar la carga fallida de {{name}}',
