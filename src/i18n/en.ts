...
const en: Record<I18nKey, string> = {
  ...
  'help.local_recommended_html': 'All features are available when connected to the same network.<ul class="help-list"><li>Connect all devices to the <strong>same Wi\u2011Fi</strong>.</li><li>A VPN or corporate firewall may block the connection.</li><li>If no network is available, connect to the host\'s hotspot.</li></ul>',
