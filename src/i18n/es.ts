...
const es: Record<I18nKey, string> = {
  ...
  'settings.sync_settings_desc':
    'Activado sigue el volumen y los efectos del anfitrión o administrador que sincronizó más recientemente. Desactivado usa los ajustes de este dispositivo.',
