...
const fr: Record<I18nKey, string> = {
  ...
  'settings.host_ctrl': 'Contrôle hôte',
  ...
  'settings.subwoofer_cutoff': 'Fréquence de croisement',
  ...
  'chat.placeholder': 'Envoyez un message ou tapez "/" pour les commandes...',
  ...
  'chat.system_audio_started_notice':
    'La diffusion audio du système a démarré. Une légère latence entre l’hôte et les invités est normale. Nous recommandons de baisser au minimum le volume de l’appareil source pour éviter les échos.',
  ...
  'youtube.enter_link_desc_html': 'Seules les vidéos ou playlists publiques peuvent être jouées.',
