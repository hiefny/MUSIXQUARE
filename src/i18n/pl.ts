...
const pl: Record<I18nKey, string> = {
  ...
  'account.stats_sessions_label': 'Sesje, do których dołączono',
  ...
  'connect.permission_inherited': 'W zestawie',
  'connect.kick_member_message': 'Usunąć wszystkie urządzenia połączone jako {{name}}?',
  'connect.device_toggle': 'Pokaż/ukryj urządzenia użytkownika {{name}}',
  'connect.device_label': 'Urządzenie {{platform}} ({{code}})',
  'connect.platform_other': 'Inne',
  ...
  'connect.signaling_restart': 'Uruchom sesję ponownie',
  'connect.signaling_new_room': 'Uruchom nowy pokój',
  ...
  'chat.bot_added_tracks': 'Materiały dodane przez BOT: {{count}}',
  'chat.bot_added_and_playing': 'Materiały dodane przez BOT: {{count}}. Odtwarzanie rozpoczęte',
  ...
  'pro.upload.waiting': 'Oczekiwanie na przesłanie...',
  'pro.upload.progress': 'Przesyłanie · {{percent}}%',
  'pro.upload.confirming': 'Potwierdzanie w pokoju PRO...',
  'pro.upload.completed': 'Dodano do playlisty',
  'pro.upload.failed': 'Przesyłanie nie powiodło się',
  'pro.upload.retry': 'Spróbuj ponownie',
  'pro.upload.remove': 'Usuń',
  'pro.upload.cancel_file': 'Anuluj przesyłanie {{name}}',
  'pro.upload.retry_file': 'Ponów przesyłanie {{name}}',
  'pro.upload.remove_file': 'Usuń nieudane przesyłanie {{name}}',
  ...
  'chat.tracks_added': '{{name}} dodał(a) {{count}} materiałów',
  'chat.track_added_named': '{{name}} dodał(a) 1 materiał: {{title}}',
  'chat.tracks_added_named': '{{name}} dodał(a) {{count}} materiałów, w tym {{title}}',
