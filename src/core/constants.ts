...
export const MSG = {
  ...
  REQUEST_SETTINGS_SYNC_SNAPSHOT: 'request-settings-sync-snapshot',
  ...
  SETTINGS_SYNC_SNAPSHOT: 'settings-sync-snapshot',
  PUBLISH_SETTINGS_SYNC_SNAPSHOT: 'publish-settings-sync-snapshot',
