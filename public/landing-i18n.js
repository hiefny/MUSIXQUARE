...
(function () {
  ...
  addLang('zh-hant', {
    ...
    'standin.platform_label': '平台',
    'standin.platform_value': '電腦上的 Chromium 核心瀏覽器',
  ...
  addLang('es', {
    ...
    'standin.desktop_label': 'PC de escritorio',
    ...
    'standin.platform_value': 'Navegadores basados en Chromium en computadoras',
  ...
  addLang('fr', {
    ...
    'header.logo_aria': 'Retour en haut',
    ...
    'standin.platform_value': 'Navigateurs basés sur Chromium sur ordinateur',
  ...
  addLang('nl', {
    ...
    'code.lead':
      'Start een sessie en deel de zescijferige code. Elk apparaat met een browser doet binnen enkele seconden mee.',
    'code.aria_code': 'Voorbeeld van een sessiecode',
    ...
    'remote.whisper_sender': 'privé aan HOST',
    'remote.whisper_msg': 'vraag in de mededeling om playlisttips',
    'sync.h2': 'Tot op het frame nauwkeurig<br>over verschillende netwerken',
    'sync.lead':
      'Elk apparaat meet de retourvertraging naar de host en stemt de weergave vervolgens af op een gedeelde klok.',
    'sync.video_label': 'MEDIA',
    'sync.video_value': 'Framenauwkeurige mediaweergave',
    ...
    'standin.h2': 'Geen luidsprekers<br>bij je computer?',
    'standin.lead':
      'MUSIXQUARE springt snel bij. Een telefoon en een tablet uit je tas zijn genoeg om te beginnen.',
    'standin.aria':
    ...
    'standin.caveat':
      'Let op: systeem-audio delen heeft onvermijdelijke vertraging. De host moet daarom het volume van het eigen apparaat zo laag mogelijk zetten.',
  ...
  addLang('pl', {
    ...
    'standin.platform_value': 'Przeglądarki oparte na Chromium na komputerach',
    'standin.caveat':
      'Uwaga: tryb udostępniania audio systemowego ma nieuniknione opóźnienie. Host powinien maksymalnie ściszyć własne urządzenie.',
  ...
  addLang('ru', {
    ...
    'standin.caveat':
      'Примечание: в режиме трансляции системного аудио задержка неизбежна. Хосту стоит максимально снизить громкость своего устройства.',
  ...
  addLang('tr', {
    ...
    'standin.caveat':
      'Not: Sistem sesi paylaşım modunda kaçınılmaz gecikme olur. Host kendi cihazının sesini mümkün olduğunca kısmalıdır.',
    'cta.h2': 'Şimdi başla',
  ...
  addLang('id', {
    ...
    'header.logo_aria': 'Kembali ke atas',
  ...
  addLang('vi', {
    ...
    'remote.whisper_sender': 'tin riêng tới HOST',
    ...
    'standin.platform_value': 'Trình duyệt dựa trên Chromium trên máy tính',
  ...
  addLang('th', {
    ...
    'remote.whisper_sender': 'ข้อความส่วนตัวถึง HOST',
    'remote.whisper_msg': 'ลองปักประกาศขอเพลงแนะนำดู',
    'sync.h2': 'แม่นระดับเฟรม<br>ข้ามเครือข่าย',
    'sync.lead': 'แต่ละอุปกรณ์วัดค่าหน่วงกับโฮสต์ แล้วจัดเวลาเล่นให้ตรงกับนาฬิการ่วมกัน',
    ...
    'standin.caveat':
      'หมายเหตุ: โหมดแชร์เสียงระบบมีค่าหน่วงที่หลีกเลี่ยงไม่ได้ โฮสต์จึงควรลดเสียงอุปกรณ์ของตัวเองให้มากที่สุด',
    'cta.h2': 'เริ่มเลย',
