...
const ptBr: Record<I18nKey, string> = {
  ...
  'connect.administrator_list': 'Administradores: {{count}}',
  ...
  'connect.administrator_revoke_aria': 'Revogar administrador de {{name}}',
  ...
  'connect.permission_inherited': 'Incluído',
  ...
  'connect.signaling_restart': 'Reiniciar sessão',
  ...
  'demo.role_title': 'Papel do dispositivo',
  ...
  'demo.host_only_exit': 'Só o host pode apertar isso.',
  ...
  'setup.set_role': 'Papel do dispositivo',
  ...
  'youtube.enter_source': 'Digite um link do YouTube ou busca',
  ...
  'network.session_full_detail':
    'Esta sala já atingiu o máximo de 100 dispositivos conectados, incluindo o host.',
  ...
  'toast.virtual_bass_on': 'O grave virtual está ativado.',
  'toast.virtual_bass_off': 'O grave virtual está desativado.',
  'toast.virtual_treble_on': 'O agudo virtual está ativado.',
  'toast.virtual_treble_off': 'O agudo virtual está desativado.',
  ...
  'toast.host_only_control': 'Só o host pode controlar isso',
  ...
  'toast.unsupported_files_excluded': 'Arquivos não compatíveis ignorados: {{count}}',
  ...
  'dialog.large_room_file.message':
    'Na mesma rede, a transferência direta de arquivos é estável para até 8 dispositivos de participantes, sem contar o do host. Em salas locais maiores, os arquivos podem ser distribuídos pelo Cloudflare R2.\n\nContinuar?',
  ...
  'pro.use_this_tab': 'Usar esta guia',
  ...
  'setup.how_to_connect_html':
    'Digite o <strong>código de 6 dígitos</strong> do host para conectar.<ul class="help-list"><li><strong>Host:</strong> “Criar sala” → conferir o código</li><li><strong>Participante:</strong> “Entrar em uma sala” → digitar o código</li><li>Até <strong>100 dispositivos, incluindo o host</strong>, podem se conectar.</li></ul>',
