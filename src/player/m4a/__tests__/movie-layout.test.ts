...
function handlerBody(handlerType: string, name: Uint8Array = new Uint8Array(0)): Uint8Array {
...
function selfContainedDataReference(
  entryType = 'url ',
  urlPayload: Uint8Array = Uint8Array.of(0, 0, 0, 1),
  entryCount = 1,
...
function soundMediaHeader(bytes: Uint8Array = new Uint8Array(8)): Uint8Array {
