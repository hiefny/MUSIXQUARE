...
const vi: Record<I18nKey, string> = {
  ...
  'connect.permission_inherited': 'Mặc định',
  'connect.kick_member_message': 'Mời tất cả thiết bị kết nối với tên {{name}} ra?',
  ...
  'connect.signaling_restart': 'Khởi động lại phiên',
