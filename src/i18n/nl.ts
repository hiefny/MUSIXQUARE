...
const nl: Record<I18nKey, string> = {
  ...
  'chat.decode_skip_notice': 'Nummer overgeslagen: niet ondersteund op sommige apparaten.',
  ...
  'chat.system_audio_stopped_notice':
    'Systeem-audio delen is gestopt. Host, zet je volume gerust weer hoger om als speaker mee te spelen.',
