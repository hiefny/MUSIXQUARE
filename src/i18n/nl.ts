...
const nl: Record<I18nKey, string> = {
  ...
  'account.login_message':
    'Log in met Google om je nickname in alle kamers te behouden. Je kunt MUSIXQUARE ook zonder inloggen blijven gebruiken.',
  ...
  'account.change_nickname': 'Nickname wijzigen',
  'account.logout': 'Uitloggen',
  'account.delete_account': 'Account verwijderen',
  'account.nickname_title': 'Nickname instellen',
  'account.nickname_message': 'Kies de nickname die je op MUSIXQUARE gebruikt.',
  ...
  'account.nickname_whitespace': 'Een nickname mag geen spaties of onzichtbare tekens bevatten.',
  ...
  'connect.signaling_restart': 'Sessie opnieuw starten',
  'connect.signaling_new_room': 'Nieuwe kamer starten',

  // Setup and demo
  'setup.host_button': 'Ruimte maken',
  'setup.guest_button': 'Deelnemen aan ruimte',
  ...
  'chat.cmd_d_nick': 'Nickname wijzigen',
