...
const tr: Record<I18nKey, string> = {
  ...
  'settings.ui_sounds_desc': 'Bildirim, giriş-çıkış ve dokunma seslerini açıp kapatabilirsiniz.',
  'settings.reverb_desc': 'Sesin yankısını ve tınısını ayarlayın.',
  'settings.eq_desc': 'Sesin tonunu ayarlayın. Ses düzeyi denetimiyle birlikte kullanın.',
