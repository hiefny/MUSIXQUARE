...
export const FILE_PLAYBACK_V2_UNIVERSAL_V1_SEMANTIC_COHORT_ID =
  'file-playback;session=v2;route=universal-v1;flac=wasm-0.2.10;linear-pcm=worker-v1;mp3=mpg123-1.0.3;adts-aac=webcodecs-v1;m4a-aac=webcodecs-v1;semrev=s1-krIHujghe98JCxZyFfrnLNmsksT6adtAQ-dzY1oHUiI' as const;
