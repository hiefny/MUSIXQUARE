...
const ko = {
  ...
  // ─── Chat Commands ──────────────────────────────────────────────
  'chat.muted_placeholder': '채팅이 제한되었습니다',
  'chat.cmd_frozen': '채팅이 동결되었습니다',
  'chat.cmd_unfrozen': '채팅 동결이 해제되었습니다',
  'chat.cmd_frozen_blocked': '현재 채팅이 동결 상태입니다',
  'chat.cmd_muted': '{{name}} 님이 채팅 금지되었습니다',
  'chat.cmd_unmuted': '{{name}} 님의 채팅 금지가 해제되었습니다',
  'chat.cmd_clear': '채팅이 초기화되었습니다',
  'chat.cmd_filter_on': '비속어 필터가 활성화되었습니다',
  'chat.cmd_filter_off': '비속어 필터가 비활성화되었습니다',
  'chat.cmd_slowmode_on': '슬로우 모드: {{sec}}초 간격으로 메시지 전송 가능',
  'chat.cmd_slowmode_off': '슬로우 모드가 해제되었습니다',
  'chat.cmd_slowmode_wait': '{{sec}}초 후에 메시지를 보낼 수 있습니다',
  ...
  'network.op_granted': '관리자 권한이 부여되었습니다.',
  'network.op_revoked': '관리자 권한이 해제되었습니다.',
  ...
  'chat.msg_truncated': '메시지가 {{max}}자로 잘렸습니다',
