...
const ru: Record<I18nKey, string> = {
  ...
  // ─── Player ──────────────────────────────────────────────────────
  'player.no_media': 'Нет воспроизводимых файлов',
  ...
  'playlist.shuffle_on': 'Случайный выбор включен',
  'playlist.shuffle_off': 'Случайный выбор отключен',
  ...
  'settings.surround_title': 'Виртуальный surround',
  'settings.bass_title': 'Виртуальный бас',
  'settings.exciter_title': 'Виртуальный возбудитель высоких частот',
  ...
  'connect.rename_message': 'Выберите никнейм, видимый другим.',
  ...
  'connect.device_list': '{{count}} подключенных устройств',
  ...
  'connect.cannot_reduce': 'Невозможно уменьшить лимит: {{count}} устройств уже подключено',
  ...
  'connect.room_password_on': 'Пароль включен',
  ...
  'demo.try_later_toast': 'Вы можете начать тур в любое время на вкладке «Справка»',
  ...
  'demo.session_body_connected':
    'Сейчас подключено {{count}} устройств.\nНазначьте роль для каждого устройства.',
  ...
  'help.connect_all_wifi': 'Соединение наиболее стабильно, когда все устройства находятся в одной сети Wi-Fi',
  ...
  'help.youtube_no_effects': 'В режиме совместного просмотра YouTube расширенные звуковые эффекты и управление ролями недоступны.',
  'help.media_synced_detail': 'Выбранные треки воспроизводятся в идеальной синхронизации на всех подключенных устройствах.',
  'help.wifi_hotspot': 'Вы также можете использовать мобильную точку доступа (Hotspot) для подключения всех устройств к одной сети',
  ...
  'chat.input_label': 'Сообщение чата',
  'chat.send': 'Отправить',
  'chat.start': 'Сообщений пока нет. Напишите что-нибудь для начала!',

  // ─── Chat Commands ──────────────────────────────────────────────
  'chat.muted_placeholder': 'Вы не можете отправлять сообщения в этот чат',
  ...
  'chat.cmd_muted': '{{name}} был заглушен',
  'chat.cmd_unmuted': 'Заглушение для {{name}} было снято',
  ...
  'chat.cmd_slowmode_on': 'Медленный режим включен: вы можете отправлять сообщения раз в {{sec}} сек.',
  'chat.cmd_slowmode_off': 'Медленный режим отключен',
  'chat.cmd_slowmode_wait': 'Подождите {{sec}} секунд перед отправкой следующего сообщения',
  'chat.cmd_notice_prefix': 'Объявление',
  'chat.system_sender': 'Система',
  'chat.decode_skip_notice': 'Некоторые устройства не смогли декодировать трек. Переход к следующему треку...',
  'chat.system_audio_started_notice':
    'Общий доступ к системному звуку запущен. Поскольку задержка между хостом и гостями неизбежна, рекомендуем хосту снизить громкость своего устройства до минимума.',
  ...
  'chat.cmd_help_target_hint': '* [устройство] — это идентификатор устройства (например, #1)',
  ...
  'chat.cmd_d_slowmode': 'Устанавливает интервал между сообщениями (slow mode)',
  ...
  'chat.debug_copied': 'Информация об отладке скопирована в буфер обмена.\nЕсли вы обнаружили ошибку, отправьте ее разработчику.',
  ...
  'youtube.effects_disabled': 'В режиме совместного просмотра YouTube\nрасширенные звуковые эффекты отключены.',
  ...
  'youtube.search_prompt': 'Нажмите Enter или Поиск для нахождения видео',
  ...
  'network.session_full': 'Комната полна',
  'network.session_full_detail':
    'Достигнут лимит подключенных устройств.\nХост может увеличить лимит на вкладке «Подключение».',
  ...
  'toast.added_tracks': 'Добавлено {{count}} треков',
  ...
  'toast.invite_code_settings': 'Вы можете поделиться ссылкой для приглашения на вкладке «Подключение».',
  ...
  'dialog.large_room_file.title': 'Делитесь файлами в большой комнате',
  'dialog.large_room_file.message':
    'Локальный общий доступ к файлам стабильно работает при не более чем 8 гостях в одной сети Wi-Fi.\n\nЖелаете продолжить?',
  'dialog.large_room_sysaudio.title': 'Делитесь системным звуком в большой комнате',
  'dialog.large_room_sysaudio.message':
    'Общий доступ к системному звуку поддерживает как локальных, так и удаленных гостей. Мы рекомендуем не более 4 гостей во избежание перегрузки и задержек.\n\nЖелаете продолжить?',
  'dialog.continue': 'Продолжить',
  'connect.slot_guide.aria': 'Открыть руководство по рекомендуемому лимиту гостей',
  'connect.slot_guide.title': 'Рекомендуемый лимит гостей',
  'connect.slot_guide.body':
    'Чем больше гостей подключается к комнате, тем сильнее снижается стабильность системы.\n\n• Совместный YouTube: до 32 гостей\n• Локальные файлы: до 8 гостей\n• Системный звук: рекомендуется не более 4 гостей',
  ...
  'toast.hprecision_sync': 'Высокоточная синхронизация: загрузка аудио...',
  'toast.file_ready': 'Файл готов!\nНажмите кнопку «Воспроизвести».',
  'toast.host_sync_not_recommended': 'Рекомендуется настраивать синхронизацию прямо на устройстве гостя',
  'toast.host_sync_requested':
    'Запрошена точная синхронизация. Настройте ручную синхронизацию на устройстве гостя.',
  'toast.sync_not_in_system_audio': 'Синхронизация не поддерживается в режиме общего доступа к системному звуку',
  'toast.sync_not_ready': 'Не готово. Попробуйте еще раз через минуту',
  ...
  'toast.yt_rendezvous_no_data': 'Нет данных воспроизведения от хоста. Попробуйте еще раз через минуту',
  ...
  'toast.session_mismatch': 'Несоответствие сессии. Повторная передача файла...',
  ...
  'transfer.file_sending': 'Отправка файла в процессе...',
  ...
  'share.remote.uploading': 'Загрузка зашифрованного файла в процессе...',
  'share.remote.upload_ready': 'Удаленный общий доступ готов',
  'share.remote.waiting': 'Ожидание удаленного файла...',
  'share.remote.downloading': 'Скачивание удаленного файла в процессе...',
  ...
  'share.remote.rate_limited': 'Слишком много запросов удаленного общего доступа.\nПопробуйте еще раз через минуту',
  'share.remote.auth_failed': 'Авторизация удаленного общего доступа не удалась. Проверьте настройки Worker.',
  'share.remote.expired': 'Срок действия ссылки на удаленный файл истек.\nПоделитесь им еще раз.',
  'share.remote.unavailable': 'Удаленный общий доступ недоступен.\nПопробуйте еще раз через минуту.',
  ...
  'transfer.receiving_0pct': 'Получение в процессе... 0%',
  'transfer.check_conn_type': 'Проверка типа подключения...',
  'transfer.preload_pending': 'Ожидание предзагрузки: {{name}}',
  'transfer.waiting_recovery': 'Ожидание восстановления для: {{name}}',
  'transfer.preparing_name': 'Готовится: {{name}}',
  'transfer.recovery_failed': 'Восстановление файла не удалось. Попробуйте еще раз.',

  // ─── Error ───────────────────────────────────────────────────────
  'error.https_required': 'Требуется HTTPS: для этой функции необходимо безопасное соединение.',
  'error.browser_update': 'Пожалуйста, обновите браузер (iOS 15.2+, Chrome 86+ или новее)',
  ...
  'error.decode_timeout': 'Декодирование «{{name}}» занимает слишком много времени.\nПереход к следующему треку...',
  ...
  'error.peer_not_ready': 'Соединение peer еще не готово',
  ...
  'error.host_left': 'Хост комнаты закрыл сессию',
  ...
  'error.room_password_auth_timeout': 'Нестабильная сеть. Попробуйте ввести пароль еще раз.',
  ...
  'dialog.leaving_session': 'Выход в процессе...',
  'dialog.background_resume_title': 'Приложение перешло в фоновый режим',
  'dialog.background_resume_message':
    'При возникновении проблем с синхронизацией или отсутствием звука, полностью перезапустите приложение.',
  ...
  'dialog.session_lost_msg':
    'Приложение перешло в энергосберегающий режим или потеряло сеть, прервав связь с остальными устройствами. Перезапустите для открытия новой сессии.',
  'dialog.session_lost_btn': 'Перезапустить',

  // ─── HTML Blocks (used with data-i18n-html) ────────────────────
  'help.install_app_html':
    'Нравится MUSIXQUARE? Вы можете установить его как приложение.<ul class="help-list"><li><strong>iOS:</strong> Поделиться → Добавить на экран "Домой"</li><li><strong>Android:</strong> Меню → Установить приложение</li><li><strong>Windows:</strong> Установить иконку в адресной строке</li><li><strong>macOS:</strong> Поделиться → Добавить в Dock</li></ul>',
  ...
  'chat.msg_truncated': 'Сообщение урезано до {{max}} символов',
  'chat.scroll_to_bottom': 'Прокрутить вниз',
  'setup.brand_tagline_html': 'Слушайте вместе, где бы вы ни были.<br>Идеальное звуковое окружение.',
  ...
  'youtube.enter_link_desc_html': 'Можно воспроизводить только публичные видео.',
  ...
  'system_audio.no_audio_track': 'Опция "Поделиться звуком" не была активирована.\nПопробуйте еще раз.',
  ...
  'system_audio.stopped': 'Трансляция системного звука завершена.\nВоспроизведение плейлиста возобновлено.',
  'system_audio.many_devices_warning':
    'Трансляция системного звука стабильно работает при не более чем 4 гостях.\nБольшее количество может вызвать задержки или прерывания.',
