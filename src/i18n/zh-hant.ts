...
const zhHant: Record<I18nKey, string> = {
  ...
  'connect.rename_profanity': '檢測到不當暱稱。',
  ...
  'connect.cannot_reduce': '當前已連接 {{count}} 台裝置，無法縮減容量',
  ...
  'demo.effects_step_title': '打造您的專屬高級音效。',
  'demo.effects_step_subtitle': '您隨時可以在「設定」中對高級聲學效果進行微調。',
  'demo.finish_step_title': '您已全部準備就緒！',
  ...
  'setup.change_later': '您隨時可以在「設定」中進行調整。',
  ...
  'setup.connect_devices': '立即連線您的其他裝置以開始。',
  'setup.enter_code_connect': '在嘉賓裝置上輸入此代碼',
  ...
  'chat.close': '關閉聊天',
  'chat.open': '開啟聊天',
  'chat.placeholder': '傳送訊息，或輸入「/」使用指令...',
  'chat.input_label': '輸入聊天訊息',
  'chat.send': '傳送訊息',
  'chat.start': '暫無訊息。傳送訊息以開始！',
