...
interface FixtureConfiguration {
  bareSupportAllowlist: readonly unknown[];
  cohortDeclaration: string;
  cohortExport: string;
  criticalEntryFiles: readonly string[];
  flacPackageRoot: string;
  integrationFiles: readonly string[];
  mp3PackageRoot: string;
  packageRoots: readonly string[];
  relativeSupportAllowlist: readonly unknown[];
  schema: string;
