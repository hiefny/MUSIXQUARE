...
const en: Record<I18nKey, string> = {
  ...
  'pro.upload.waiting': 'Waiting to upload...',
  'pro.upload.progress': 'Uploading · {{percent}}%',
  'pro.upload.confirming': 'Confirming with the PRO room...',
  'pro.upload.completed': 'Added to playlist',
  'pro.upload.failed': 'Upload failed',
  'pro.upload.retry': 'Retry',
  'pro.upload.remove': 'Remove',
  'pro.upload.cancel_file': 'Cancel upload of {{name}}',
  'pro.upload.retry_file': 'Retry upload of {{name}}',
  'pro.upload.remove_file': 'Remove failed upload of {{name}}',
