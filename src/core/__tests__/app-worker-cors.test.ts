...
<rss version="2.0">
  ...
  it('keeps /admin unindexed and no-store cached', async () => {
    ...
    expect(html).toContain('/admin.css?v=8.3.21');
    expect(html).toContain('/admin.js?v=8.3.21');
    expect(html).toContain('data-admin-asset-version="8.3.21"');
  ...
  it('forces admin assets through no-store browser and CDN caching', async () => {
    ...
    for (const path of ['/admin.js?v=8.3.21', '/admin.css?v=8.3.21']) {
