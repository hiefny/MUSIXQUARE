...
const ko = {
  ...
  'settings.sync_settings_desc': '이 옵션이 켜진 기기들끼리 볼륨과 음향 효과가 동기화돼요.',
  ...
  'connect.signaling_recover_action': '복구',
  ...
  'dialog.background_resume_sync_fallback_message':
    '싱크가 맞지 않거나 소리가 나지 않으면 앱을 완전히 종료한 뒤 다시 열어주세요.',
  'dialog.got_it': '알겠어요',
  'dialog.continue_using': '계속',
  'dialog.leave_session': '나가기',
