...
const nl: Record<I18nKey, string> = {
  ...
  'pro.use_this_tab': 'Overnemen',
  'pro.uploading': 'Opslaan in PRO-ruimte...',
  'pro.upload.waiting': 'Upload wacht...',
  'pro.upload.progress': 'Uploaden · {{percent}}%',
  'pro.upload.confirming': 'Bevestigen in de PRO-ruimte...',
  'pro.upload.completed': 'Toegevoegd aan playlist',
  'pro.upload.failed': 'Upload mislukt',
  'pro.upload.retry': 'Opnieuw proberen',
  'pro.upload.remove': 'Verwijderen',
  'pro.upload.cancel_file': 'Upload van {{name}} annuleren',
  'pro.upload.retry_file': 'Upload van {{name}} opnieuw proberen',
  'pro.upload.remove_file': 'Mislukte upload van {{name}} verwijderen',
