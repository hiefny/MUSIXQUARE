...
const BUFFERED_AMOUNT_ALLOWLIST = new Map([
  [
...
const PUMP_IMPORTERS = ['src/storage/transfer-send.ts', 'src/storage/preload.ts'];
...
const sources = new Map(); // relPath -> comment-stripped text
