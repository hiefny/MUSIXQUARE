/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.pro-room.toml --env-interface=MusixquareProRoomEnv cloudflare/types/pro-room.generated.d.ts` (hash: e646e925b6fddda3e509ba5ae468e3ed)
// Runtime types generated with workerd@1.20260908.1 2026-07-16 
interface __BaseEnv_MusixquareProRoomEnv {
	PRO_MEDIA_BUCKET: R2Bucket;
	...
	PRO_ROOMS: DurableObjectNamespace<import("../pro-room-worker").MusixquareProRoom>;
	MUSIXQUARE_SERVICE_CONTROL: DurableObjectNamespace<import("../pro-room-worker").MusixquareServiceControl>;
	PRO_SIGNALING_ROOMS: DurableObjectNamespace /* MusixquareRoom from musixquare-signaling */;
	DEVELOPER_API_LIMITERS: DurableObjectNamespace /* DeveloperApiRateLimiter from musixquare-developer-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../pro-room-worker");
		durableNamespaces: "MusixquareProRoom" | "MusixquareServiceControl";
	}
	interface Env extends __BaseEnv_MusixquareProRoomEnv {}
}
interface MusixquareProRoomEnv extends __BaseEnv_MusixquareProRoomEnv {}
