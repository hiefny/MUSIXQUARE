...
const it: Record<I18nKey, string> = {
  ...
  'app.search_description':
    'Trasforma smartphone, tablet e computer in un unico sistema audio wireless sincronizzato. Riproduci insieme musica, YouTube e l’audio di sistema nel browser, senza installare nulla.',
  ...
  'settings.help_translate': 'Aiuta a tradurre',
  ...
  'setup.enter_host_code': "Inserisci il codice d'invito",
  'setup.enter_host_code_alt': 'Scansiona il codice QR o inserisci il codice.',
  'setup.scan_qr': 'Tocca per scansionare',
  ...
  'chat.decode_memory_risk_system_message':
    'Questa traccia può usare circa {{estimatedMiB}} MiB di memoria durante la decodifica e potrebbe non essere riprodotta su questo dispositivo.',
