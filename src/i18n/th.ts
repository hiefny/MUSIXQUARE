/**
 * MUSIXQUARE - Thai Translations (Draft)
 *
...
const th: Record<I18nKey, string> = {
  ...
  'settings.reverb_decay': 'การจางของรีเวิร์บ',
  ...
  'settings.subwoofer_adjust': 'คัตออฟซับวูฟเฟอร์',
  'settings.subwoofer_cutoff': 'ความถี่คัตออฟของซับวูฟเฟอร์',
  'settings.default_0pct': 'ค่าเริ่มต้น 0%',
  'settings.default_01s': 'ค่าเริ่มต้น 0.1 วินาที',
  'settings.default_20khz': 'ค่าเริ่มต้น 20.0 kHz',
  'settings.default_20hz': 'ค่าเริ่มต้น 20 Hz',
  'settings.default_5s': 'ค่าเริ่มต้น 5.0 วินาที',
  'settings.invite_code': 'รหัสเชิญ',
  'settings.leave_session': 'ออกจากเซสชัน',
  'connect.rename_device': 'เปลี่ยนชื่ออุปกรณ์',
  ...
  'player.play_speakers': 'เล่นผ่านลำโพง',
  ...
  'connect.no_session': 'เริ่มเซสชันก่อน',
  ...
  'connect.kick_message': 'นำอุปกรณ์นี้ออกจากเซสชันหรือไม่?',
  'connect.kick_yes': 'นำออก',
  'connect.kick_no': 'ไม่',
  'connect.kicked_title': 'ถูกนำออก',
  'connect.kicked_message': 'คุณถูกโฮสต์นำออกจากเซสชัน',
  'connect.copy_invite_link': 'คัดลอกลิงก์เชิญ',
  'connect.link_copied': 'คัดลอกลิงก์เชิญแล้ว',
  'connect.room_password_title': 'ต้องใช้รหัสผ่านเพื่อเข้าร่วม',
  ...
  // Setup and demo
  'setup.host_button': 'ฉันจะเป็นโฮสต์',
  'setup.guest_button': 'เข้าร่วมเซสชัน',
  ...
  'demo.role_title': 'ตั้งค่าบทบาทของอุปกรณ์นี้',
  ...
  'setup.set_role': 'ตั้งค่าบทบาทของอุปกรณ์นี้',
  'setup.what_sound': 'อุปกรณ์นี้ควรเล่นเสียงอะไร?',
  'setup.change_later': 'คุณเปลี่ยนภายหลังได้ในตั้งค่า',
  'setup.welcome_title': 'ยินดีต้อนรับ',
  'setup.join_session_subtitle': 'คุณกำลังจะเข้าร่วมเซสชัน {{code}}',
  'setup.select_role': 'โปรดเลือกบทบาท',
  'setup.select_role_alt': 'โปรดเลือกบทบาท',
  'setup.hello_select_role': 'สวัสดี! โปรดเลือกบทบาทของคุณ',
  'setup.enter_code': 'ใส่รหัส 6 หลัก',
  'setup.enter_host_code': 'ใส่รหัส 6 หลักจากโฮสต์',
  'setup.enter_host_code_alt': 'ใส่รหัสของโฮสต์',
  'setup.connect_devices': 'ตอนนี้เชื่อมต่ออุปกรณ์อื่น',
  'setup.enter_code_connect': 'ใส่รหัสนี้บนอุปกรณ์อื่น',
  'setup.last_step': 'พร้อมเริ่มหรือยัง?',
  ...
  'help.local_recommended': 'แนะนำเครือข่ายท้องถิ่น',
  ...
  'network.cant_join': 'หาเซสชันไม่พบ\nโปรดตรวจสอบเครือข่าย',
  'network.session_full': 'เซสชันเต็มแล้ว',
  ...
  'error.session_create_fail': 'สร้างเซสชันไม่ได้',
  'error.network_generic': 'เกิดข้อผิดพลาดเครือข่าย',
  'error.host_unreachable': 'ดูเหมือนโฮสต์ออกจากเซสชันแล้ว',
  ...
  'error.peer_unavailable': 'หาเซสชันไม่พบ\nตรวจสอบรหัสอีกครั้ง',
  'error.host_left': 'ดูเหมือนโฮสต์ออกจากเซสชันแล้ว',
  ...
  'error.session_id_unavailable': 'ใช้ ID เซสชันไม่ได้\nโปรดลองอีกครั้ง',
  ...
  'dialog.return_home_title': 'ออกจากเซสชัน',
  'dialog.return_home_msg': 'กลับไปหน้าจอเริ่มต้น?',
  'dialog.return_home_detail': 'คุณจะตัดการเชื่อมต่อจากเซสชันปัจจุบัน',
  'dialog.leaving_session': 'กำลังออกจากเซสชัน...',
  ...
  'dialog.leave_session': 'ออกจากเซสชัน',
  ...
  'dialog.session_lost_msg':
    'แอปเข้าสู่โหมดพักหรือการเชื่อมต่อหลุด อุปกรณ์อื่นจึงหลุดไปแล้ว รีสตาร์ตเพื่อเริ่มเซสชันใหม่',
  ...
  'setup.how_to_connect_html':
    'ป้อน <strong>รหัส 6 หลัก</strong> จากโฮสต์เพื่อเชื่อมต่อ<ul class="help-list"><li><strong>โฮสต์:</strong> “ฉันจะเป็นโฮสต์” → ตรวจสอบรหัส</li><li><strong>ผู้เข้าร่วม:</strong> “เข้าร่วมเซสชัน” → ป้อนรหัส</li><li>จำนวนอุปกรณ์ที่เชื่อมต่อได้ตั้งค่าได้ใน <strong>แท็บ "เชื่อมต่อ"</strong></li></ul>',
