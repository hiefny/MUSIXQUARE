\
    ...
    Write-Host "Downloading Pretendard (v1.3.9) variable font..."
    Invoke-WebRequest `
    ...
    # Invoke-WebRequest `
    #   -Uri "https://cdn.jsdelivr.net/npm/pretendard@1.3.9/dist/web/variable/woff/PretendardVariable.woff" `
    #   -OutFile (Join-Path $fonts "PretendardVariable.woff")
