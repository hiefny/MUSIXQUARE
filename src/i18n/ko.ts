...
const ko = {
  ...
  'system_audio.many_devices_warning':
    '시스템 오디오 공유는 최대 4명 정도를 권장해요. 인원이 많으면 지연이나 끊김이 늘 수 있어요.',
