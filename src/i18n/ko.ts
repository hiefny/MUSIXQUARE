...
const ko = {
  ...
  'error.host_left': '방장가 세션을 종료한 것 같아요',
  ...
  'setup.play_together_desc_html': '방장가 미디어를 재생하면<br>연결된 모든 기기에서 동시에 재생돼요.<br>동기화 버튼을 눌러서 싱크를 맞춰보세요.',
