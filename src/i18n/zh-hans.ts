...
const zhHans: Record<I18nKey, string> = {
  ...
  'account.google_continue': '使用 Google 继续',
  'account.terms': '条款',
  'account.privacy': '隐私',
  'account.unavailable': '暂时无法登录。你仍可不登录继续使用。',
  'account.account_title': '账号',
  'account.stats_sessions_label': '参与的会话',
  ...
  'settings.reverb_desc': '调节声音的混响和回响。',
  ...
  'playlist.track_fallback': '项目 {{idx}}',
  'playlist.deferred_load_hint': '播放后加载所有项目信息',
  ...
  'connect.permission_inherited': '基本权限',
  ...
  'connect.signaling_new_room': '开始新房间',
  ...
  'system_audio.coordinator_update_required': '请更新正在管理此房间的设备。',
  ...
  'toast.remote_decode_device_wait': '有设备无法解码此项目。其他设备会继续播放。',
  'toast.invite_code': '邀请码：{{code}}',
  'toast.invite_code_info': '{{count}} 台已连接 | 代码 {{code}}',
  'toast.added_tracks': '已添加 {{count}} 项',
  ...
  'toast.media_management_required': '管理媒体需要权限。',
  'toast.playback_control_required': '需要播放控制权限。',
  'toast.member_management_required': '需要移出成员的权限。',
  'toast.chat_notice_required': '需要发布聊天公告的权限。',
  'toast.room_owner_required': '只有房间所有者可以更改此项。',
  'toast.system_audio_owner_required': '只有房间所有者可以共享或停止系统音频。',
  ...
  'pro.claim_retry_message': '连接已中断。链接仅安全保留在此页面中，你可以重试。',
  ...
  'chat.bot_added_tracks': 'BOT 已添加 {{count}} 项',
  ...
  'chat.tracks_added': '{{name}} 添加了 {{count}} 项',
  'chat.track_added_named': '{{name}} 添加了 1 项：{{title}}',
  'chat.tracks_added_named': '{{name}} 添加了 {{count}} 项，包括 {{title}}',
