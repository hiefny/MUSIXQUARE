...
const pl: Record<I18nKey, string> = {
  ...
  'account.stats_listening_label': 'Wspólny czas słuchania',
  'account.stats_tracks_label': 'Odtworzone utwory',
