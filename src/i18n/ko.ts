...
const ko = {
  ...
  'chat.party_on_bpm': '🎉 파티 모드 ON · {{bpm}} BPM',
  'chat.party_on_detecting': '🎉 파티 모드 ON · BPM 감지 중...',
  'chat.party_off': '파티 모드 OFF',
  ...
  'legal.content_html':
    '<strong>개인정보 처리방침</strong><br>같은 네트워크에서는 세션 데이터가 기기 간에 직접 전송되며, 연결 수립을 위한 IP 주소와 연결 정보만 시그널링 서버를 경유해요. 다만 원격 파일 공유와 원격 시스템 오디오 공유는 실제 데이터가 Cloudflare를 경유해요. 원격 파일 공유의 경우 암호화된 데이터가 서버에 최대 24시간 임시 저장되며, 복호화 키는 저장소에 보관되지 않아요. 뮤직스퀘어는 기능 제공 외의 목적으로 데이터를 열람, 분석, 보관하지 않아요. <a href="/privacy?lang=ko" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">자세히 보기</a><br><br><strong>저작권 관련 유의사항</strong><br>뮤직스퀘어를 통해 공유되는 음악, 영상 등의 콘텐츠에 대한 저작권은 해당 권리자에게 있어요. 시스템 오디오 공유 및 파일 공유 기능은 개인적인 이용을 위한 것이며, 저작권이 있는 콘텐츠의 무단 배포 및 공개 송신에 대한 책임은 사용자에게 있어요. YouTube 공유는 공식 재생 방식을 사용하며, 조회 및 권리 처리는 해당 서비스의 정책과 권리자 설정을 따르게 되어있어요. <a href="/terms?lang=ko" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">자세히 보기</a><br><br><strong>면책 조항</strong><br>뮤직스퀘어는 무료로 제공되고 있어요. 다만 일부 기능이 YouTube나 Cloudflare 등 외부 서비스에 의존하며, 해당 서비스의 변경이나 중단으로 인한 일시적인 기능 제한이 발생할 수 있어요. 실시간 오디오 동기화와 원격 공유 품질은 네트워크 환경, 브라우저 정책, 기기 성능에 따라 크게 달라질 수 있어요. 또한 모바일 데이터 환경에서 사용 시 데이터 요금이 발생할 수 있어요. <a href="/terms?lang=ko" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">자세히 보기</a><br><br><strong>© 2026 MUSIXQUARE</strong><br><a href="/about" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">About</a> · <a href="/history" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">History</a> · <a href="/designsystem" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">Design System</a> · <a href="https://discord.gg/PmmFhGTBsX" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">Discord</a><br><a href="mailto:contact@musixquare.com" data-copy-email="contact@musixquare.com" style="color:inherit;text-decoration:none">contact@musixquare.com</a>',
} as const;
