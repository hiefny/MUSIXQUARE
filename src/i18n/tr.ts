...
const tr: Record<I18nKey, string> = {
  ...
  'playlist.delete_selected': 'Seçilenleri sil ({{count}})',
  'playlist.video_fallback': 'Yükleniyor...',
  'playlist.track_fallback': 'Medya {{idx}}',
  'playlist.deferred_load_hint': 'Tüm medya bilgilerini yüklemek için oynatmayı başlatın',
