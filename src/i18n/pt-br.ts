...
const ptBr: Record<I18nKey, string> = {
  ...
  'pro.use_this_tab': 'Substituir',
  'pro.uploading': 'Salvando na sala PRO...',
  'pro.upload.waiting': 'Upload aguardando...',
  'pro.upload.progress': 'Enviando · {{percent}}%',
  'pro.upload.confirming': 'Confirmando na sala PRO...',
  'pro.upload.completed': 'Adicionado à playlist',
  'pro.upload.failed': 'Falha no upload',
  'pro.upload.retry': 'Tentar novamente',
  'pro.upload.remove': 'Remover',
  'pro.upload.cancel_file': 'Cancelar o upload de {{name}}',
  'pro.upload.retry_file': 'Tentar novamente o upload de {{name}}',
  'pro.upload.remove_file': 'Remover o upload com falha de {{name}}',
