...
const ja: Record<I18nKey, string> = {
  ...
  'account.stats_listening_label': '一緒に聴いた時間',
  'account.stats_tracks_label': '再生した曲',
