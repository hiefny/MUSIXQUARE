/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.app.toml --env-interface=MusixquareAppEnv cloudflare/types/app.generated.d.ts` (hash: 8e2243390be3ca57bb987de70395e8c7)
// Runtime types generated with workerd@1.20260722.1 2026-05-04 
interface __BaseEnv_MusixquareAppEnv {
	SORO_RSS_BACKUP: KVNamespace;
	SORO_IMAGE_BUCKET: R2Bucket;
	MUSIXQUARE_ADMIN_DB: D1Database;
	DEVELOPER_API_DB: D1Database;
	MUSIXQUARE_AUTH_DB: D1Database;
	MXQR_CAPABILITY_POW_ROOM_PRESSURE: RateLimit;
	MXQR_CAPABILITY_POW_GENERAL_PRESSURE: RateLimit;
	ASSETS: Fetcher;
	...
	MXQR_CAPABILITY_POW_ADAPTIVE_ENABLED: "false";
	MXQR_CAPABILITY_POW_ADAPTIVE_MAX_DIFFICULTY: "16";
	PRO_ROOM_ADMIN_ROOMS: DurableObjectNamespace /* MusixquareProRoom from musixquare-pro-room */;
	...
	PRO_ROOM_PUBLIC_API: Fetcher /* musixquare-pro-room */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../app-worker");
	}
	interface Env extends __BaseEnv_MusixquareAppEnv {}
}
interface MusixquareAppEnv extends __BaseEnv_MusixquareAppEnv {}
