...
const zhHant: Record<I18nKey, string> = {
  ...
  'connect.room_password_title': '需要房間密碼',
  ...
  'setup.enter_code': '輸入代碼',
  'setup.enter_host_code': '輸入主持人代碼',
  ...
  'dialog.session_lost_msg':
    '應用程式進入睡眠或失去連線，其他裝置已經中斷。請重新啟動以建立新房間。',
