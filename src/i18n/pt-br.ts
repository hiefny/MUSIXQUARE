/**
 * MUSIXQUARE - Brazilian Portuguese Translations (Draft)
 *
...
const ptBr: Record<I18nKey, string> = {
  ...
  'common.revoke': 'Revogar OP',
  'common.grant': 'Conceder OP',
  ...
  'settings.host_ctrl': 'Controle do host',
  'settings.self_ctrl': 'Controle próprio',
  ...
  'connect.rename_device': 'Alterar nome do dispositivo',
  'connect.rename_title': 'Alterar nome do dispositivo',
  'connect.rename_message': 'Digite um nome visível para outras pessoas.',
  ...
  'connect.rename_profanity': 'Este nome contém linguagem imprópria.',
  ...
  'player.play_together': 'Reproduzir juntos',
  'player.play_speakers': 'Reproduzir pelos alto-falantes',
  ...
  'connect.cannot_reduce': '{{count}} dispositivos já estão conectados',
  'connect.kick_title': 'Expulsar dispositivo',
  'connect.kick_message': 'Remover este dispositivo da sessão?',
  'connect.kick_yes': 'Expulsar',
  'connect.kick_no': 'Não',
  'connect.kicked_title': 'Expulso',
  'connect.kicked_message': 'Você foi removido da sessão pelo host.',
  'connect.copy_invite_link': 'Copiar link de convite',
  'connect.link_copied': 'Link de convite copiado',
  'connect.room_password_title': 'Exigir senha para entrar',
  ...
  // Setup and demo
  'setup.host_button': 'Serei o host',
  'setup.guest_button': 'Entrar em uma sessão',
  'setup.demo_button': 'Experimentar (demo)',
  'demo.prompt_title': 'Experimente o MUSIXQUARE',
  'demo.prompt_message': 'Parece que você é novo aqui. Quer testar o básico?',
  'demo.prompt_cta': 'Experimentar',
  'demo.prompt_later': 'Agora não',
  'demo.try_later_toast': 'Você pode experimentar quando quiser pela aba Ajuda.',
  'demo.track_info': 'Informações da faixa',
  'demo.exit': 'Sair da demo',
  'demo.credit': 'Faixa demo',
  'demo.role_title': 'Definir o papel deste dispositivo',
  ...
  'demo.effects_step_title': 'Crie um som mais rico.',
  ...
  'setup.set_role': 'Definir o papel deste dispositivo',
  'setup.what_sound': 'O que este dispositivo deve tocar?',
  'setup.change_later': 'Você pode mudar isso depois nas Configurações.',
  'setup.welcome_title': 'Boas-vindas',
  'setup.join_session_subtitle': 'Você está prestes a entrar na sessão {{code}}.',
  ...
  'setup.enter_code_connect': 'Digite este código em outros dispositivos',
  ...
  'help.install_app': 'Instalar como app',
  ...
  'network.cant_join': 'Não foi possível encontrar a sessão.\nVerifique sua rede.',
  'network.session_full': 'A sessão está cheia',
  ...
  'share.remote.encrypting': 'Criptografando arquivo para convidados remotos…',
  ...
  'toast.host_sync_not_recommended': 'Ajuste a sincronização em um dispositivo convidado',
  'toast.host_sync_requested':
    'Sincronização precisa solicitada.\nAjuste a sincronização manual em um dispositivo convidado.',
  ...
  'toast.yt_host_sync_sent': 'Sinal de autosync enviado aos convidados',
  ...
  'error.session_create_fail': 'Não foi possível criar sessão',
  'error.network_generic': 'Ocorreu um erro de rede',
  'error.host_unreachable': 'Parece que o host saiu da sessão',
  ...
  'error.peer_unavailable': 'Não foi possível encontrar a sessão.\nConfira o código novamente.',
  'error.host_left': 'Parece que o host saiu da sessão',
  ...
  'error.session_id_unavailable': 'ID da sessão indisponível.\nTente novamente.',
  ...
  'dialog.large_room_file.message':
    'O compartilhamento local de arquivos é estável com até ~8 convidados na rede local.\n\nContinuar?',
  'dialog.large_room_sysaudio.title': 'Áudio do sistema em sala grande',
  'dialog.large_room_sysaudio.message':
    'O compartilhamento de áudio do sistema aceita convidados locais e remotos, mas até ~4 convidados é recomendado por carga e latência do host.\n\nContinuar?',
  ...
  'dialog.leave_session': 'Sair da sessão',
  ...
  'dialog.session_lost_msg':
    'O app entrou em repouso ou perdeu a conexão, então os outros dispositivos já caíram. Reinicie para começar uma nova sessão.',
  ...
  'chat.placeholder': 'Chat ou digite "/" para comandos',
  'chat.input_label': 'Digite uma mensagem de chat',
  'chat.send': 'Enviar mensagem',
  'chat.start': 'Comece a conversar',
  ...
  'chat.cmd_d_deop': 'Revogar operador',
  ...
  'connect.slot_guide.aria': 'Abrir guia de quantidade recomendada de convidados',
  'connect.slot_guide.title': 'Número de convidados',
  'connect.slot_guide.body':
    'Quanto mais convidados se conectam, menos estável o sistema fica.\n\n• YouTube juntos: até 32\n• Compartilhamento de arquivo local: até 8\n• Compartilhamento de áudio do sistema: até 4 recomendado',
  ...
  'setup.how_to_connect_html':
    'Digite o <strong>código de 6 dígitos</strong> do host para conectar.<ul class="help-list"><li><strong>Host:</strong> “Serei o host” → conferir código</li><li><strong>Convidado:</strong> “Entrar em uma sessão” → digitar código</li><li>A quantidade de dispositivos pode ser configurada na <strong>aba "Conectar"</strong>.</li></ul>',
  'player.play_speakers_html':
    'Cada convidado seleciona um <strong>papel (canal de saída)</strong>.<ul class="help-list"><li><strong>Centro:</strong> saída estéreo padrão</li><li><strong>Esquerda:</strong> saída do canal L</li><li><strong>Direita:</strong> saída do canal R</li><li><strong>Subwoofer:</strong> saída de mix de graves</li></ul>Você pode mudar papéis quando quiser em <strong>Configurações</strong>.',
