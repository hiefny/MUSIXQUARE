...
const nl: Record<I18nKey, string> = {
  ...
  'account.stats_listening_label': 'Samen geluisterde tijd',
  'account.stats_tracks_label': 'Afgespeelde nummers',
  ...
  'toast.added_tracks': '{{count}} nummers toegevoegd',
