...
const ru: Record<I18nKey, string> = {
  ...
  'settings.sync_settings_desc':
    'Вкл.: использовать громкость и аудиоэффекты ведущего или администратора, который синхронизировал настройки последним. Выкл.: использовать настройки этого устройства.',
