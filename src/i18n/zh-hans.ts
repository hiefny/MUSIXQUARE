...
const zhHans: Record<I18nKey, string> = {
  ...
  'toast.yt_rendezvous_start': '正在对齐主持人...',
  ...
  'dialog.large_room_file.message': '本地文件共享在同一网络下最多约 8 位参与者较稳定。\n\n继续吗？',
  ...
  'chat.system_audio_started_notice':
    '系统音频共享已开始。可用时，远程参与者可通过 Cloudflare 接收。主持人和参与者之间出现一些延迟是正常的，因此主持人应尽量降低源设备音量。',
  'chat.system_audio_stopped_notice':
    '系统音频共享已结束。主持人请把音量调回，作为房间扬声器使用。',
  ...
  'setup.how_to_connect_html':
    '输入主持人提供的<strong>6 位代码</strong>进行连接。<ul class="help-list"><li><strong>主持人：</strong>“成为主持人” → 查看代码</li><li><strong>参与者：</strong>“加入房间” → 输入代码</li><li>可连接的设备数量可在<strong>“连接”标签页</strong>中设置。</li></ul>',
  ...
  'player.play_media_action_html':
    '主持人有 3 个选项。<ul class="help-list"><li><strong>加载本地文件：</strong>从设备中选择音乐。支持精确同步</li><li><strong>一起看 YouTube：</strong>支持视频和播放列表。不支持声道分离和音频效果</li><li><strong>系统音频共享：</strong>主持人使用 Windows 或 Mac 的 Chrome 时可用</li></ul>',
  'help.need_help_html':
