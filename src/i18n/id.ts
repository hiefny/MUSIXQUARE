...
const id: Record<I18nKey, string> = {
  ...
  'settings.virtual_effects_desc':
    'Menerapkan efek sintesis pada audio. Ini dapat menyebabkan distorsi berat.',
  ...
  'playlist.jump_to_current': 'Buka track yang sedang diputar',
  'playlist.reorder_handle': 'Urutkan ulang {{title}}, posisi {{position}}',
  'playlist.reorder_position': '{{title}}, posisi {{position}} dari {{total}}',
  'playlist.repeat_all': 'Pengulangan semua track diaktifkan',
  'playlist.repeat_one': 'Pengulangan track saat ini diaktifkan',
  ...
  'playlist.delete_selected': 'Hapus {{count}} track terpilih',
  'playlist.video_fallback': 'Memuat...',
  'playlist.track_fallback': 'Track {{idx}}',
  'playlist.deferred_load_hint': 'Putar untuk memuat info semua track',
  ...
  'connect.permission_chat_notice': 'Kirim pengumuman chat',
  ...
  'toast.unsupported_files_excluded': '{{count}} file yang tidak didukung akan dilewati.',
  ...
  'pro.active_tab_message': 'Melanjutkan di sini akan memutus tab yang lama.',
  'pro.use_this_tab': 'Gunakan tab ini',
  'pro.upload.batch_progress': 'Mengunggah trek {{current}}/{{total}}',
  'pro.upload.batch_failed_title': 'Beberapa trek tidak dapat diunggah',
  ...
  'chat.bot_added_tracks': 'BOT menambahkan {{count}} track',
  'chat.bot_added_and_playing': 'BOT menambahkan {{count}} track dan mulai memutar',
  ...
  'chat.tracks_added': '{{name}} menambahkan {{count}} track',
  'chat.track_added_named': '{{name}} menambahkan 1 track: {{title}}',
  'chat.tracks_added_named': '{{name}} menambahkan {{count}} track, termasuk {{title}}',
