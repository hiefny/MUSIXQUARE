/**
 * MUSIXQUARE - Japanese Translations (Draft)
 *
...
const ja: Record<I18nKey, string> = {
  ...
  'settings.leave_session': 'セッションを退出',
  ...
  'demo.session_title': 'これはルーム {{code}} です。',
  ...
  'setup.what_sound': 'このデバイスで何を鳴らしますか？',
  'setup.change_later': 'あとで設定から変更できます。',
  'setup.welcome_title': 'ようこそ',
  'setup.join_session_subtitle': 'セッション {{code}} に参加しようとしています。',
  ...
  'setup.enter_code_connect': 'このコードを他のデバイスで入力してください',
  'setup.last_step': '開始する準備はできましたか？',
  'setup.joining': '参加中...',
  ...
  'network.cant_join': 'セッションが見つかりませんでした。\nネットワークを確認してください。',
  ...
  'transfer.download_finishing': 'ダウンロードを完了中...',
  ...
  'toast.added_tracks': '{{count}}件のトラックを追加しました',
  ...
  'toast.video_only_rejected': '動画ファイルは追加できません。',
  ...
  'toast.operator_required': 'オーディオ設定を変更できるのは管理者だけです',
  ...
  'error.host_unreachable': 'ホストがセッションを退出したようです',
  ...
  'dialog.session_lost_msg':
    'アプリがスリープしたか接続を失ったため、他のデバイスはすでに切断されています。新しいセッションを始めるには再起動してください。',
  ...
  'chat.cmd_help_target_hint': '* [device] は固有番号です（例: #1）',
  ...
  'chat.cmd_u_w': '/w [device] [メッセージ]',
  'chat.cmd_u_whisper': '/whisper [device] [メッセージ]',
  ...
  'setup.how_to_connect_html':
    'ホストの<strong>6桁コード</strong>を入力して接続します。<ul class="help-list"><li><strong>ホスト:</strong> 「ホストになる」→ コードを確認</li><li><strong>ゲスト:</strong> 「セッションに参加」→ コードを入力</li><li>接続できるデバイス数は<strong>「接続」タブ</strong>で設定できます。</li></ul>',
  ...
  'setup.invite_share_desc_html':
    '複数のデバイスをワイヤレスで接続し<br>大きなオーディオシステムを作れます。<br>6桁コードで接続します。',
