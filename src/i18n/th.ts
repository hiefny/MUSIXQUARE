...
const th: Record<I18nKey, string> = {
  ...
  'account.stats_listening_label': 'เวลาที่ฟังร่วมกัน',
  'account.stats_tracks_label': 'เพลงที่เล่น',
  ...
  'player.prev_track': 'เพลงก่อนหน้า',
  'player.next_track': 'เพลงถัดไป',
  'player.repeat_mode': 'เปลี่ยนโหมดเล่นซ้ำ',
  'player.shuffle_mode': 'เปลี่ยนโหมดสุ่ม',
  'player.play_media': 'เล่นเพลง',
  'player.play_media_action': 'เล่นเพลง',
  'player.add_media': 'เพิ่มเพลง',
  'player.play_start': 'เพิ่มลงคิว',
  'player.select_media': 'โปรดเลือกเพลงที่จะเล่น',
  ...
  'chat.tracks_added': '{{name}} เพิ่ม {{count}} เพลง',
