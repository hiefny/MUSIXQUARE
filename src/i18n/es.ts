...
const es: Record<I18nKey, string> = {
  ...
  'settings.subwoofer_cutoff': 'Corte del subwoofer',
  ...
  'player.play_speakers': 'Por altavoces',
  ...
  'setup.guest_button': 'Entrar en una sala',
  ...
  'setup.enter_code_connect': 'Código para otro dispositivo',
