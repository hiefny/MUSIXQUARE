...
const en: Record<I18nKey, string> = {
  ...
  'toast.video_not_music_one': "{{name}} isn't a music file. Paste a YouTube link for videos instead.",
  'toast.video_not_music_many': "{{count}} files aren't music. Paste YouTube links for videos instead.",
