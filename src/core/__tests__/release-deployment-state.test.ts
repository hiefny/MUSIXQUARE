...
describe('release deployment rollback state', () => {
  ...
  it('uses CI critical browser coverage while keeping the production release browser-free', () => {
    ...
    expect(packageJson.scripts['test:e2e:critical']).toBe(
      'playwright test e2e/critical-browser.test.ts e2e/release-smoke.test.ts e2e/remote-upload-browser.test.ts e2e/background-resume.test.ts e2e/adaptive-actions.test.ts --project=chromium --reporter=line',
    );
