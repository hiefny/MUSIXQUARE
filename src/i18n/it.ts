...
const it: Record<I18nKey, string> = {
  ...
  'setup.enter_host_code_alt': "Scansiona il codice QR o inserisci il codice d'invito.",
  ...
  'setup.connect_devices': 'Scansiona il QR su un altro dispositivo o inserisci il codice.',
