/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.developer-api.toml --env-interface=MusixquareDeveloperApiEnv cloudflare/types/developer-api.generated.d.ts` (hash: 70d85d3f8459eb4539037d577dce7624)
// Runtime types generated with workerd@1.20260722.1 2026-07-17 
interface __BaseEnv_MusixquareDeveloperApiEnv {
	DEVELOPER_API_DB: D1Database;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	DEVELOPER_API_MODE: "enabled";
	DEVELOPER_API_LIMITERS: DurableObjectNamespace<import("../developer-api-worker").DeveloperApiRateLimiter>;
	MUSIXQUARE_SERVICE_CONTROL: DurableObjectNamespace /* MusixquareServiceControl from musixquare-pro-room */;
	DEVELOPER_API_FACADE: Fetcher /* musixquare-developer-api-facade */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../developer-api-worker");
		durableNamespaces: "DeveloperApiRateLimiter";
	}
	interface Env extends __BaseEnv_MusixquareDeveloperApiEnv {}
}
interface MusixquareDeveloperApiEnv extends __BaseEnv_MusixquareDeveloperApiEnv {}
