...
const nl: Record<I18nKey, string> = {
  ...
  'settings.help_translate': 'Help vertalen',
  ...
  'setup.enter_host_code': 'Voer de uitnodigingscode in',
  'setup.enter_host_code_alt': 'Scan de QR-code of voer de code in.',
  'setup.scan_qr': 'Tik om te scannen',
