...
const de: Record<I18nKey, string> = {
  ...
  'connect.rename_device': 'Gerät umbenennen',
  'connect.rename_title': 'Gerät umbenennen',
  'connect.rename_message': 'Wähle einen Spitznamen, den andere sehen.',
  'connect.rename_placeholder': 'Neuer Spitzname (max. 20 Zeichen)',
  'connect.rename_current': 'Aktueller Spitzname',
  'connect.rename_empty': 'Der Spitzname darf nicht leer sein.',
