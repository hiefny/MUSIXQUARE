...
const I18N_EN: Record<string, string> = {
  ...
  "VPN/사내 보안망이 켜져 있으면 연결이 안 될 수 있어요.": "A VPN or corporate firewall may block the connection.",
  ...
  "동일 Wi-Fi로 연결하면 파일 기능도 이용할 수 있어요!": "Connect via the same Wi-Fi to enjoy file sharing!",
  "동일한 네트워크": "same network",
  "동일한 Wi‑Fi": "the same Wi‑Fi",
  "두 기기가 같은 네트워크인지 확인해 보세요.": "Make sure both devices are on the same network.",
  "모든 기기를": "Connect all devices to",
  "라이트": "Light",
  "로우패스": "Low-pass",
  "로컬 네트워크 권장": "Local network recommended",
  ...
  "연결이 안 되면 호스트의 핫스팟에 연결 후 앱을 새로고침해주세요.": "If it won't connect, join the host's hotspot and refresh the app.",
  ...
  "서버 오류일 수 있어요. 이런 경우 두 기기를 같은 네트워크에 연결해주세요.": "It may be a server issue. In that case, connect both devices to the same network.",
