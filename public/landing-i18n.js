...
(function () {
  ...
  addLang('zh-hans', {
    ...
    'array.lead': '每台设备都可以负责左声道、右声道、低音炮或完整立体声。整个房间都能变成一套声音系统。',
  ...
  addLang('zh-hant', {
    ...
    'array.lead': '每台裝置都能負責左聲道、右聲道、重低音或完整立體聲。整個房間都能變成一套聲音系統。',
  ...
  addLang('es', {
    ...
    'array.lead':
      'Cada dispositivo puede ser el canal izquierdo, derecho, subwoofer o estéreo completo. Toda la sala se convierte en el sistema.',
  ...
  addLang('pl', {
    ...
    'array.lead': 'Każde urządzenie może być lewym kanałem, prawym kanałem, subwooferem albo pełnym stereo. Cały pokój staje się systemem.',
  ...
  addLang('ru', {
    ...
    'array.lead': 'Каждое устройство может стать левым каналом, правым каналом, сабвуфером или полноценным стерео. Вся комната становится системой.',
  ...
  addLang('vi', {
    ...
    'array.lead': 'Mỗi thiết bị có thể đảm nhận kênh trái, kênh phải, subwoofer hoặc stereo đầy đủ. Cả căn phòng trở thành hệ thống.',
