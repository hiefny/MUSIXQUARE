...
const zhHans: Record<I18nKey, string> = {
  ...
  'demo.try_later_toast': '你随时可以从帮助标签页开始体验。',
  ...
  'demo.effects_step_title': '打造您的专属高级音效。',
  'demo.effects_step_subtitle': '您随时可以在“设置”中对高级声学效果进行微调。',
  'demo.finish_step_title': '您已全部准备就绪！',
  ...
  'setup.change_later': '您随时可以在“设置”中进行调整。',
  ...
  'setup.connect_devices': '立即连接您的其他设备以开始。',
  ...
  'chat.close': '关闭聊天',
  'chat.open': '打开聊天',
  'chat.placeholder': '发送消息，或输入“/”使用命令...',
