...
const zhHans: Record<I18nKey, string> = {
  ...
  'pro.request_new_link': '申请新链接',
  'pro.claim_unavailable_title': '此链接已无法使用',
  'pro.new_link_message': '请向链接发送者申请新的激活或恢复链接。',
