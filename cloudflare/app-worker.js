...
function boundedCapabilityInteger(raw, fallback, minimum, maximum) {
...
function parseCapabilityPowDifficulty(env, fallback = CAPABILITY_POW_DIFFICULTY_DEFAULT) {
  return boundedCapabilityInteger(
...
function isCapabilityPowAdaptiveEnabled(env) {
  return isTruthyConfigValue(env.MXQR_CAPABILITY_POW_ADAPTIVE_ENABLED);
}

function parseCapabilityPowMaxDifficulty(env, baselineDifficulty) {
