...
const ko = {
  ...
  'account.terms': '이용약관',
  'account.privacy': '개인정보 처리방침',
  'account.unavailable': '로그인을 잠시 사용할 수 없어요. 로그인 없이 계속 이용할 수 있어요.',
  'account.account_title': '계정',
  'account.stats_sessions_label': '참여한 세션',
  'account.stats_listening_label': '감상 시간',
  'account.stats_tracks_label': '재생한 미디어',
  'account.stats_count_value': '{{count}}',
  'account.stats_seconds_value': '{{seconds}}초',
  'account.stats_minutes_value': '{{minutes}}분',
  'account.stats_hours_minutes_value': '{{hours}}시간 {{minutes}}분',
  'account.change_nickname': '닉네임 바꾸기',
  'account.logout': '로그아웃',
  ...
  'nav.help': '도움말',
  'nav.connect': '연결',
  'nav.playlist_compact': '재생목록',
  'nav.connect_compact': '연결',
  'nav.settings_compact': '설정',
  ...
  'player.sync_compact': '동기화',
  'player.syncing_compact': '동기화…',
  'player.play_media': '미디어 재생',
  'player.play_media_compact': '미디어',
  ...
  'playlist.jump_to_current': '현재 재생 중인 트랙으로 이동',
  ...
  'playlist.delete_selected': '선택한 트랙 {{count}}개 삭제',
  'playlist.video_fallback': '불러오는 중...',
  'playlist.track_fallback': '트랙 {{idx}}',
  'playlist.deferred_load_hint': '재생하면 전체 트랙 정보를 불러올게요',
  ...
  'role.subwoofer_placement': '저음이 잘 퍼지는 곳에 놓아주세요',

  // ─── Settings ────────────────────────────────────────────────────
  'settings.theme': '테마',
  'settings.ui_sounds': 'UI 사운드',
  'settings.sync_settings': '설정 동기화',
  'settings.sync_settings_desc': '이 설정이 켜진 기기들끼리 볼륨과 음향 효과가 동기화돼요.',
  'settings.virtual_effects_title': '가상 효과',
  'settings.virtual_effects_desc': '음향에 합성 기술을 적용해요. 왜곡이 심해질 수 있어요.',
  'settings.virtual_effect_bass': '베이스',
  'settings.virtual_effect_treble': '트레블',
  'settings.virtual_effect_surround': '서라운드',
  'settings.language_desc': '언어를 선택하거나 시스템 언어를 따라가게 할 수 있어요.',
  'settings.theme_desc': '밝은 테마와 어두운 테마로 설정할 수 있어요.',
  'player.visualizer_mode_hint': '음향 시각화 방식을 선택할 수 있어요.',
  'settings.ui_sounds_desc': '공지음과 입장·퇴장음, 터치음을 켜고 끌 수 있어요.',
  'settings.reverb_desc': '소리의 잔향과 울림을 조절해요.',
  'settings.eq_desc': '소리의 음색을 조절해요. 볼륨 제어와 함께 사용해 주세요.',
  'settings.surround_desc': '분리도를 늘려 입체감을 증가시켜요.',
  'settings.bass_desc': '저음을 합성하여 타격감을 증가시켜요.',
  'settings.exciter_desc': '초고역을 생성하여 청량함을 증가시켜요.',
  'settings.role_center_desc':
    '이 기기가 중앙 스피커 역할을 하고 있어요.\n기기를 중앙에 놓아주세요.',
  'settings.role_left_desc': '이 기기가 왼쪽 스피커 역할을 하고 있어요.\n기기를 왼쪽에 놓아주세요.',
  ...
  'connect.administrator_list': '관리자 {{count}}명',
  'connect.room_owner_role': '방 소유자',
  'connect.administrator_role': '관리자',
  'connect.administrator_settings_aria': '{{name}} 님의 관리자 권한 설정',
  ...
  'connect.permission_media_add': '미디어 관리',
  'connect.permission_playback_control': '재생 제어',
  'connect.permission_members_kick': '멤버 추방',
  'connect.permission_chat_notice': '채팅방 공지',
  'connect.permission_inherited': '기본 권한',
  'connect.kick_member_message': '{{name}} 님과 연결된 모든 기기를 내보낼까요?',
  'connect.device_toggle': '{{name}}님의 연결 기기 펼치기/접기',
  'connect.device_label': '{{platform}} 기기 ({{code}})',
  'connect.platform_other': '기타',
  'connect.current_device': '현재 기기',
  ...
  'connect.signaling_recovering': '다시 연결 중…',
  'connect.signaling_failed': '연결 복구 실패',
  'connect.signaling_recover_action': '다시 연결',
  ...
  'connect.signaling_restart': '세션 다시 시작',
  'connect.signaling_new_room': '새 방 시작',
  ...
  'setup.enter_host_code_alt': 'QR을 스캔하거나 초대 코드를 입력해 주세요',
  'setup.scan_qr': '탭하여 스캔',
  'setup.camera_permission_denied': '카메라 권한이 없어요',
  'setup.camera_not_found': '사용 가능한 카메라가 없어요',
  'setup.camera_unavailable': '카메라를 시작할 수 없어요',
  'setup.connect_devices': '다른 기기에 QR을 스캔하거나 코드를 입력해 주세요',
  ...
  'chat.bot_added_tracks': 'BOT이 트랙 {{count}}개를 추가했어요',
  ...
  'toast.added_tracks': '트랙 {{count}}개를 추가했어요',
  ...
  'toast.preparing_next': '다음 트랙 준비 중... ({{name}})',
  'toast.preparing_next_pct': '다음 트랙 준비 중... {{pct}}%',
  ...
  'toast.virtual_treble_off': '가상 트레블이 꺼졌어요',
  'toast.virtual_surround_on': '가상 서라운드가 켜졌어요',
  'toast.virtual_surround_off': '가상 서라운드가 꺼졌어요',
  'toast.virtual_effects_off': '모든 가상 효과가 꺼졌어요',
  'toast.host_only': '방장만 실행할 수 있어요.',
  'toast.host_only_media': '방장만 미디어를 추가할 수 있어요.',
  'toast.media_management_required': '미디어 관리 권한이 필요해요.',
  'toast.playback_control_required': '재생 제어 권한이 필요해요.',
  ...
  'dialog.file_drop.message': '파일 {{count}}개를 추가할까요?',
  ...
  'pro.active_tab_message': '이 탭에서 계속하면 기존 탭의 연결이 종료돼요.',
  'pro.use_this_tab': '강제로 계속',
  'pro.upload.batch_progress': '트랙 업로드 중 {{current}}/{{total}}',
  'pro.upload.batch_failed_title': '일부 트랙을 업로드하지 못했어요',
  ...
  'chat.tracks_added': '{{name}} 님이 트랙 {{count}}개를 추가했어요',
  'chat.track_added_named': '{{name}} 님이 트랙 1개를 추가했어요: {{title}}',
