...
const th: Record<I18nKey, string> = {
  ...
  'connect.rename_device': 'เปลี่ยนชื่ออุปกรณ์เครื่องนี้',
  'connect.rename_title': 'เปลี่ยนชื่ออุปกรณ์',
  'connect.rename_message': 'ตั้งชื่อเล่นเพื่อแสดงในห้อง',
  'connect.rename_placeholder': 'ชื่อเล่นใหม่ (สูงสุด 20 ตัวอักษร)',
  'connect.rename_current': 'ชื่อเล่นปัจจุบัน',
  'connect.rename_empty': 'ชื่อเล่นต้องไม่ว่างเปล่า',
  'connect.rename_reserved': 'ไม่อนุญาตให้ใช้ชื่อเล่นนี้',
  'connect.rename_profanity': 'ตรวจพบชื่อเล่นที่ไม่เหมาะสม',
  'connect.rename_duplicate': 'ชื่อเล่นนี้ถูกใช้งานอยู่แล้ว',
