...
function _i18nTranslateSubtree(root) {
    ...
    const wasApplying = _i18nApplying;
    _i18nApplying = true;
    try {
        // Attributes
        if (root.nodeType === 1) {
        ...
        _i18nApplying = wasApplying; // Restore instead of unconditionally clearing
    }
}
...
export { i18nTranslate, setLanguageMode };
export function getResolvedLanguage() { return _resolvedLanguage; }
