...
const ja: Record<I18nKey, string> = {
  ...
  'pro.use_this_tab': '強制続行',
  'pro.uploading': 'PROルームに保存中...',
  'pro.upload.waiting': 'アップロード待機中...',
  'pro.upload.progress': 'アップロード中 · {{percent}}%',
  'pro.upload.confirming': 'PROルームで確認中...',
  'pro.upload.completed': 'プレイリストに追加しました',
  'pro.upload.failed': 'アップロードに失敗しました',
  'pro.upload.retry': '再試行',
  'pro.upload.remove': '削除',
  'pro.upload.cancel_file': '{{name}}のアップロードをキャンセル',
  'pro.upload.retry_file': '{{name}}のアップロードを再試行',
  'pro.upload.remove_file': '失敗した{{name}}のアップロードを削除',
