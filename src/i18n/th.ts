...
const th: Record<I18nKey, string> = {
  ...
  'settings.host_ctrl': 'การควบคุมของโฮสต์',
  'settings.self_ctrl': 'การควบคุมภายในเครื่อง',
  ...
  'chat.close': 'ปิดแชท',
  'chat.open': 'เปิดแชท',
  'chat.placeholder': 'ส่งข้อความ หรือพิมพ์ "/" เพื่อดูคำสั่งทั้งหมด...',
  'chat.input_label': 'พิมพ์ข้อความแชท',
  'chat.send': 'ส่งข้อความ',
  'chat.start': 'ยังไม่มีข้อความ ส่งข้อความทักทายเพื่อเริ่มการพูดคุยกันเลย!',
  ...
  'system_audio.started':
    'เสียงระบบอาจมีความหน่วงเล็กน้อย\nลดระดับเสียงต้นทางถ้าทำได้',
