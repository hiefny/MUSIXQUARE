...
const ko = {
  ...
  'toast.youtube_syncing': '유튜브 동기화 중.. 2초 뒤에 재생돼요',
  ...
  'error.host_unreachable': '호스트에 연결할 수 없어요. 같은 네트워크에 있는지 확인해 보세요.',
  ...
  'help.local_recommended_html': '동일 네트워크에 연결하면 모든 기능을 이용할 수 있어요.<ul class="help-list"><li>모든 기기를 <strong>동일 네트워크</strong>에 연결해주세요.</li><li>VPN/사내 보안망이 켜져 있으면 연결이 안 될 수 있어요.</li><li>연결이 안 되면 호스트의 핫스팟에 연결 후 앱을 새로고침해주세요.</li></ul>',
