...
const ko = {
  ...
  'legal.content_html':
    '<strong>저작권 관련 유의사항</strong><br>뮤직스퀘어를 통해 공유되는 음악, 영상 등의 콘텐츠에 대한 저작권은 해당 권리자에게 있어요. 시스템 오디오 공유 및 파일 공유 기능은 개인적인 이용을 위한 것이며, 저작권이 있는 콘텐츠의 무단 배포 및 공개 송신에 대한 책임은 사용자에게 있어요.<br><br><strong>개인정보 처리방침</strong><br>같은 네트워크에서는 실제 콘텐츠와 세션 데이터가 기기 간에 직접 전송되며, 연결 수립을 위해 IP 주소와 연결 정보만 시그널링 서버를 경유할 수 있어요. 다만 원격 파일 공유와 원격 시스템 오디오 공유 시에는 실제 데이터가 Cloudflare를 경유해요. 파일 공유의 경우 데이터는 암호화된 후 업로드되며 복호화에 필요한 키는 저장소에 보관되지 않아요. 모든 데이터는 뮤직스퀘어의 기능을 위해서만 일시적으로 저장 또는 경유하며 따로 수집 보관되지 않아요.<br><br><strong>면책 조항</strong><br>뮤직스퀘어는 무료로 제공되고 있어요. 다만 일부 기능이 YouTube, PeerJS, Cloudflare 등 외부 서비스에 의존하며, 해당 서비스의 변경이나 중단으로 인한 일시적인 기능 제한이 발생할 수 있어요. 또한 모바일 데이터 환경에서 사용 시 데이터 요금이 발생할 수 있어요.<br><br><strong>© 2026 MUSIXQUARE</strong><br><a href="/landing" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">About</a> · <a href="/history" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">History</a> · <a href="/designsystem" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">Design System</a> · <a href="https://github.com/hiefny/MUSIXQUARE" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">GitHub</a><br><a href="mailto:contact@musixquare.com" data-copy-email="contact@musixquare.com" style="color:inherit;text-decoration:none">contact@musixquare.com</a>',
} as const;
