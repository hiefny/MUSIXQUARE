...
const ko = {
  ...
  'pro.upload.waiting': '업로드 대기 중...',
  'pro.upload.progress': '업로드 중 · {{percent}}%',
  'pro.upload.confirming': 'PRO 방에서 확인하는 중...',
  'pro.upload.completed': '재생목록에 추가됨',
  'pro.upload.failed': '업로드에 실패했어요',
  'pro.upload.retry': '재시도',
  'pro.upload.remove': '제거',
  'pro.upload.cancel_file': '{{name}} 업로드 취소',
  'pro.upload.retry_file': '{{name}} 업로드 재시도',
  'pro.upload.remove_file': '실패한 {{name}} 업로드 제거',
