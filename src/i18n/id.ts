...
const id: Record<I18nKey, string> = {
  ...
  'pro.use_this_tab': 'Ambil alih',
  'pro.uploading': 'Menyimpan ke ruang PRO...',
  'pro.upload.waiting': 'Menunggu upload...',
  'pro.upload.progress': 'Mengupload · {{percent}}%',
  'pro.upload.confirming': 'Mengonfirmasi di ruang PRO...',
  'pro.upload.completed': 'Ditambahkan ke playlist',
  'pro.upload.failed': 'Upload gagal',
  'pro.upload.retry': 'Coba lagi',
  'pro.upload.remove': 'Hapus',
  'pro.upload.cancel_file': 'Batalkan upload {{name}}',
  'pro.upload.retry_file': 'Coba lagi upload {{name}}',
  'pro.upload.remove_file': 'Hapus upload {{name}} yang gagal',
