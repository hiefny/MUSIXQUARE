...
const it: Record<I18nKey, string> = {
  ...
  'settings.sync_settings_desc':
    'Se attiva, segue il volume e gli effetti audio dell’host o amministratore che ha sincronizzato più di recente. Se disattiva, usa le impostazioni di questo dispositivo.',
  'settings.dark': 'Scuro',
