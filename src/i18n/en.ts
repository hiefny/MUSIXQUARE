...
const en: Record<I18nKey, string> = {
  ...
  'settings.sync_settings_desc':
    'On follows the volume and audio effects of the host or admin who synced most recently. Off keeps this device independent.',
  'settings.dark': 'Dark',
  ...
  'connect.signaling_recover_action': 'Restore',
