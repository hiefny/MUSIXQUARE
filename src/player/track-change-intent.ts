...
// A PRO asset can legitimately take many minutes to prepare on this endpoint.
// This is only a final escape hatch for an accepted request whose control
// channel remains open but whose authoritative response never arrives.
