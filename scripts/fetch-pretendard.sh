...
echo "Downloading Pretendard (v1.3.9) variable font (WOFF2)..."
curl -L -o "${FONTS_DIR}/PretendardVariable.woff2" \
  "https://cdn.jsdelivr.net/npm/pretendard@1.3.9/dist/web/variable/woff2/PretendardVariable.woff2"

echo "Downloading license..."
curl -L -o "${FONTS_DIR}/PRETENDARD_LICENSE.txt" \
  "https://cdn.jsdelivr.net/npm/pretendard@1.3.9/dist/LICENSE.txt"
