...
const zhHant: Record<I18nKey, string> = {
  ...
  'account.stats_sessions_label': '參與的工作階段',
  ...
  'settings.role_subwoofer_desc': '此裝置目前用作重低音。\n請將它放在低音容易擴散的位置。',
  'settings.dark': '深色',
  'settings.light': '淺色',
  ...
  'youtube.video_unavailable': '影片無法播放，跳到下一項',
