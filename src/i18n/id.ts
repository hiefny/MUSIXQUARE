...
const id: Record<I18nKey, string> = {
  ...
  'nav.playlist_compact': 'Daftar',
  'nav.connect_compact': 'Hubungkan',
  'nav.settings_compact': 'Pengaturan',
  ...
  'player.visualizer_mode_hint': 'Pilih cara audio divisualisasikan.',
  ...
  'player.visualizer_circular': 'Lingkaran',
  ...
  'settings.help_translate': 'Bantu menerjemahkan',
  ...
  'player.sync_compact': 'Sinkron',
  'player.syncing_compact': 'Sinkron…',
  ...
  'connect.signaling_recovering': 'Menghubungkan ulang…',
  'connect.signaling_failed': 'Koneksi server gagal',
  'connect.signaling_recover_action': 'Hubungkan ulang',
  ...
  'setup.enter_host_code': 'Masukkan kode undangan',
  'setup.enter_host_code_alt': 'Pindai kode QR atau masukkan kode.',
  'setup.scan_qr': 'Ketuk untuk pindai',
  ...
  'system_audio.stop_compact': 'Hentikan',
