/**
 * MUSIXQUARE - German Translations (Draft)
 *
...
const de: Record<I18nKey, string> = {
  ...
  'common.revoke': 'OP entziehen',
  'common.grant': 'OP erteilen',
  ...
  'settings.self_ctrl': 'Eigene Steuerung',
  ...
  'settings.subwoofer_cutoff': 'Subwoofer-Grenzfrequenz',
  ...
  'connect.rename_device': 'Gerätenamen ändern',
  'connect.rename_title': 'Gerätenamen ändern',
  'connect.rename_message': 'Gib einen Namen ein, den andere sehen.',
  ...
  'connect.rename_profanity': 'Dieser Name enthält unangemessene Sprache.',
  'connect.rename_duplicate': 'Dieser Name wird bereits verwendet.',
  ...
  'player.play_start': 'Zur Warteschlange hinzufügen',
  'player.select_media': 'Medium zum Abspielen auswählen',
  'player.play_together': 'Gemeinsam abspielen',
  'player.play_speakers': 'Über Lautsprecher abspielen',
  ...
  'connect.kicked_message': 'Du wurdest vom Host aus der Sitzung entfernt.',
  'connect.copy_invite_link': 'Einladungslink kopieren',
  'connect.link_copied': 'Einladungslink kopiert',
  'connect.room_password_title': 'Passwort zum Beitreten verlangen',
  ...
  'setup.guest_button': 'Sitzung beitreten',
  'setup.demo_button': 'Ausprobieren (Demo)',
  'demo.prompt_title': 'MUSIXQUARE ausprobieren',
  'demo.prompt_message': 'Du scheinst neu hier zu sein. Möchtest du die Grundlagen testen?',
  'demo.prompt_cta': 'Ausprobieren',
  'demo.prompt_later': 'Nicht jetzt',
  'demo.try_later_toast': 'Du kannst es jederzeit im Hilfe-Tab ausprobieren.',
  ...
  'demo.step_connect': '1. Geräte verbinden',
  'demo.step_role': '2. Rolle festlegen',
  'demo.step_effects': '3. Audioeffekte',
  'demo.step_finish': '4. Demo beenden',
  'demo.session_title': 'Dies ist Raum {{code}}.',
  ...
  'demo.effects_step_title': 'Forme einen volleren Klang.',
  ...
  'setup.join_session_subtitle': 'Du trittst gleich Sitzung {{code}} bei.',
  ...
  'setup.six_digit_enter': 'Bitte gib den 6-stelligen Code ein',

  // Help
  'help.need_help': 'Brauchst du Hilfe?',
  'help.install_app': 'Als App installieren',
  ...
  'network.cant_join': 'Sitzung konnte nicht gefunden werden.\nBitte prüfe dein Netzwerk.',
  'network.session_full': 'Die Sitzung ist voll',
  ...
  'toast.video_only_rejected': 'Videodateien können nicht hinzugefügt werden.',
  ...
  'toast.operator_required': 'Nur Admins können Audioeinstellungen ändern',
  ...
  'error.host_unreachable': 'Der Host scheint die Sitzung verlassen zu haben',
  ...
  'error.peer_unavailable': 'Sitzung konnte nicht gefunden werden.\nBitte Code erneut prüfen.',
  'error.host_left': 'Der Host scheint die Sitzung verlassen zu haben',
  ...
  'error.session_id_unavailable': 'Sitzungs-ID ist nicht verfügbar.\nBitte erneut versuchen.',
  ...
  'dialog.leave_session': 'Sitzung verlassen',
  ...
  'dialog.session_lost_msg':
    'Die App ist eingeschlafen oder hat die Verbindung verloren, daher sind andere Geräte bereits getrennt. Starte neu, um eine neue Sitzung zu beginnen.',
  ...
  'chat.placeholder': 'Chat oder "/" für Befehle eingeben',
  ...
  'chat.cmd_help_target_hint': '* [device] ist eine eindeutige Nummer (z. B. #1)',
  ...
  'chat.cmd_u_w': '/w [device] [Nachricht]',
  'chat.cmd_u_whisper': '/whisper [device] [Nachricht]',
  ...
  'setup.how_to_connect_html':
    'Gib den <strong>6-stelligen Code</strong> des Hosts ein, um dich zu verbinden.<ul class="help-list"><li><strong>Host:</strong> „Ich bin der Host“ → Code prüfen</li><li><strong>Gast:</strong> „Sitzung beitreten“ → Code eingeben</li><li>Die Anzahl verbindbarer Geräte kann im <strong>Tab „Verbinden“</strong> festgelegt werden.</li></ul>',
