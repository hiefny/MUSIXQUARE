...
const de: Record<I18nKey, string> = {
  ...
  'share.remote.downloading': 'Verschlüsselte Remote-Datei wird heruntergeladen...',
  ...
  'pro.upload.waiting': 'Upload wartet...',
  'pro.upload.progress': 'Wird hochgeladen · {{percent}} %',
  'pro.upload.confirming': 'Wird im PRO-Raum bestätigt...',
  'pro.upload.completed': 'Zur Playlist hinzugefügt',
  'pro.upload.failed': 'Upload fehlgeschlagen',
  'pro.upload.retry': 'Erneut versuchen',
  'pro.upload.remove': 'Entfernen',
  'pro.upload.cancel_file': 'Upload von {{name}} abbrechen',
  'pro.upload.retry_file': 'Upload von {{name}} erneut versuchen',
  'pro.upload.remove_file': 'Fehlgeschlagenen Upload von {{name}} entfernen',
