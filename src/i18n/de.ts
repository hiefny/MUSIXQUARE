...
const de: Record<I18nKey, string> = {
  ...
  'setup.enter_host_code_alt': 'Scanne den QR-Code oder gib den Einladungscode ein.',
  ...
  'setup.connect_devices': 'Scanne den QR-Code auf einem anderen Gerät oder gib den Code ein.',
