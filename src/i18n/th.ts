...
const th: Record<I18nKey, string> = {
  ...
  'settings.help_translate': 'ช่วยแปล',
  ...
  'chat.cmd_muted': '{{name}} ส่งข้อความในแชตไม่ได้แล้ว',
  ...
  'chat.cmd_d_mute': 'จำกัดสิทธิ์แชตของอุปกรณ์',
