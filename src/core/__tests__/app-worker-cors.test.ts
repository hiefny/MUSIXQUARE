...
<rss version="2.0">
  ...
  it('keeps /admin unindexed and no-store cached', async () => {
    ...
    expect(html).toContain('/admin.css?v=8.4.19');
    expect(html).toContain('/clearable-editors.js?v=8.4.19');
    expect(html).toContain('/admin.js?v=8.4.19');
    expect(html.indexOf('/clearable-editors.js')).toBeLessThan(html.indexOf('/admin.js'));
    expect(html).toContain('data-admin-asset-version="8.4.19"');
