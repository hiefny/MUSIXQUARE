...
const vi: Record<I18nKey, string> = {
  ...
  'pro.use_this_tab': 'Tiếp quản',
  'pro.uploading': 'Đang lưu vào phòng PRO...',
  'pro.upload.waiting': 'Đang chờ tải lên...',
  'pro.upload.progress': 'Đang tải lên · {{percent}}%',
  'pro.upload.confirming': 'Đang xác nhận trong phòng PRO...',
  'pro.upload.completed': 'Đã thêm vào danh sách phát',
  'pro.upload.failed': 'Tải lên thất bại',
  'pro.upload.retry': 'Thử lại',
  'pro.upload.remove': 'Xóa',
  'pro.upload.cancel_file': 'Hủy tải lên {{name}}',
  'pro.upload.retry_file': 'Thử tải lên {{name}} lần nữa',
  'pro.upload.remove_file': 'Xóa lượt tải lên {{name}} bị lỗi',
