...
const ru: Record<I18nKey, string> = {
  ...
  'network.session_full_detail':
    'В этой комнате достигнут лимит подключенных устройств.\nПопросите хоста увеличить его на вкладке «Подключение».',
  ...
  'share.remote.auth_failed': 'Авторизация удаленного общего доступа не удалась.\nПроверьте настройки Worker',
  ...
  'error.signal_server_fail': 'Невозможно связаться с сигнальным сервером.\nПопробуйте еще раз через минуту.',
