/**
 * MUSIXQUARE - Spanish Translations (Draft)
 *
...
const es: Record<I18nKey, string> = {
  ...
  'settings.self_ctrl': 'Control propio',
  ...
  'settings.reverb_lowcut': 'Corte bajo de reverb',
  'settings.reverb_highcut': 'Corte alto de reverb',
  ...
  'connect.rename_device': 'Cambiar nombre del dispositivo',
  'connect.rename_title': 'Cambiar nombre del dispositivo',
  'connect.rename_message': 'Introduce un nombre visible para los demás.',
  'connect.rename_placeholder': 'Nombre nuevo (máx. 20 caracteres)',
  'connect.rename_current': 'Nombre actual',
  'connect.rename_reserved': 'Este nombre no está permitido.',
  'connect.rename_profanity': 'Este nombre contiene lenguaje inapropiado.',
  ...
  'playlist.empty_hint_guest': 'Esperando a que el host añada medios.',
  ...
  'connect.cannot_reduce': '{{count}} dispositivos ya están conectados',
  'connect.kick_title': 'Expulsar dispositivo',
  'connect.kick_message': '¿Eliminar este dispositivo de la sesión?',
  'connect.kick_yes': 'Expulsar',
  'connect.kick_no': 'No',
  'connect.kicked_title': 'Expulsado',
  'connect.kicked_message': 'El host te eliminó de la sesión.',
  'connect.copy_invite_link': 'Copiar enlace de invitación',
  'connect.link_copied': 'Enlace de invitación copiado',
  'connect.room_password_title': 'Requerir contraseña para unirse',
  ...
  'setup.guest_button': 'Unirse a una sesión',
  'setup.demo_button': 'Probarlo (demo)',
  'demo.prompt_title': 'Prueba MUSIXQUARE',
  'demo.prompt_message': 'Parece que eres nuevo aquí. ¿Quieres probar lo básico?',
  'demo.prompt_cta': 'Probar',
  'demo.prompt_later': 'Ahora no',
  'demo.try_later_toast': 'Puedes probarlo cuando quieras desde la pestaña Ayuda.',
  'demo.track_info': 'Información de pista',
  'demo.exit': 'Salir de la demo',
  'demo.credit': 'Pista demo',
  'demo.role_title': 'Configurar el rol de este dispositivo',
  ...
  'demo.effects_step_title': 'Dale forma a un sonido más rico.',
  'demo.effects_step_subtitle': 'Puedes ajustar todo más tarde en Ajustes.',
  'demo.finish_step_title': 'Ese fue el recorrido rápido.',
  'demo.finish_step_subtitle': 'Vuelve a la app para usar todas las funciones.',
  ...
  'setup.set_role': 'Configurar el rol de este dispositivo',
  'setup.what_sound': '¿Qué debe reproducir este dispositivo?',
  'setup.change_later': 'Puedes cambiarlo más tarde en Ajustes.',
  'setup.welcome_title': 'Bienvenido',
  'setup.join_session_subtitle': 'Estás a punto de unirte a la sesión {{code}}.',
  ...
  'setup.last_step': '¿Listo para empezar?',
  ...
  'network.cant_join': 'No se pudo encontrar la sesión.\nRevisa tu red.',
  'network.session_full': 'La sesión está llena',
  ...
  'error.host_unreachable': 'Parece que el host salió de la sesión',
  ...
  'error.peer_unavailable': 'No se pudo encontrar la sesión.\nRevisa el código de nuevo.',
  'error.host_left': 'Parece que el host salió de la sesión',
  ...
  'error.session_id_unavailable': 'El ID de sesión no está disponible.\nInténtalo de nuevo.',
  ...
  'dialog.leave_session': 'Salir de la sesión',
  ...
  'dialog.session_lost_msg':
    'La app se suspendió o perdió conexión, así que los demás dispositivos ya se desconectaron. Reinicia para comenzar una nueva sesión.',
  ...
  'chat.placeholder': 'Chat o escribe "/" para comandos',
  'chat.input_label': 'Escribe un mensaje de chat',
  'chat.send': 'Enviar mensaje',
  'chat.start': 'Empieza a chatear',
  ...
  'chat.decode_skip_notice':
    'Algunos dispositivos no pudieron reproducir esta pista, saltando a la siguiente',
  'chat.system_audio_started_notice':
    'Se inició la compartición de audio del sistema. Los participantes remotos pueden recibirlo por Cloudflare cuando esté disponible. Algo de retraso entre host y participantes es normal, así que el host debería bajar al máximo el volumen del dispositivo fuente.',
  ...
  'chat.cmd_already_op': '{{name}} ya es operador',
  'chat.cmd_not_op': '{{name}} no es operador',
  'chat.cmd_help_title': 'Comandos disponibles',
  'chat.cmd_help_target_hint': '* [device] es un número único (ej. #1)',
  ...
  'chat.cmd_u_w': '/w [device] [mensaje]',
  'chat.cmd_u_whisper': '/whisper [device] [mensaje]',
  ...
  'chat.cmd_d_deop': 'Revocar operador',
  ...
  'setup.how_to_connect_html':
    'Introduce el <strong>código de 6 dígitos</strong> del host para conectarte.<ul class="help-list"><li><strong>Host:</strong> “Ser host” → revisar código</li><li><strong>Invitado:</strong> “Unirse a una sesión” → introducir código</li><li>La cantidad de dispositivos se puede configurar en la <strong>pestaña "Conectar"</strong>.</li></ul>',
  ...
  'youtube.enter_link_desc_html': 'Solo se pueden ver videos públicos.',
