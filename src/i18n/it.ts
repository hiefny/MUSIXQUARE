...
const it: Record<I18nKey, string> = {
  ...
  'connect.permissions_title': 'Permessi amministratore',
  'connect.permission_media_add': 'Aggiungi contenuti',
