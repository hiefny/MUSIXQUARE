...
const ja: Record<I18nKey, string> = {
  ...
  'account.unavailable': '現在ログインを利用できません。ログインせずに続けられます。',
  'account.account_title': 'アカウント',
  'account.stats_sessions_label': '参加したセッション',
  'account.stats_listening_label': '再生時間',
  'account.stats_tracks_label': '再生したメディア',
  'account.stats_count_value': '{{count}}',
  'account.stats_seconds_value': '{{seconds}}秒',
  'account.stats_minutes_value': '{{minutes}}分',
  'account.stats_hours_minutes_value': '{{hours}}時間{{minutes}}分',
  'account.change_nickname': 'ニックネームを変更',
  'account.logout': 'ログアウト',
  'account.delete_account': 'アカウントを削除',
  'account.nickname_title': 'ニックネームを設定',
  'account.nickname_message': 'MUSIXQUAREで使うニックネームを決めてください。',
  ...
  'account.action_failed':
    'アカウントを更新できませんでした。しばらくしてからもう一度お試しください。',
  ...
  'nav.help': 'ヘルプ',
  'nav.connect': '接続',
  'nav.playlist_compact': '再生リスト',
  'nav.connect_compact': '接続',
  ...
  'settings.sync_settings': '設定の同期',
  'settings.sync_settings_desc':
    'この設定をオンにしたデバイス同士で、音量とオーディオ効果が同期されます。',
  'settings.virtual_effects_title': 'バーチャルエフェクト',
  'settings.virtual_effects_desc':
    '音声に合成エフェクトをかけます。強い歪みが生じる場合があります。',
  'settings.virtual_effect_bass': 'ベース',
  'settings.virtual_effect_treble': 'トレブル',
  'settings.virtual_effect_surround': 'サラウンド',
  'settings.language_desc': '言語を選ぶか、システムの言語に合わせられます。',
  'settings.theme_desc': 'ライトテーマとダークテーマを選べます。',
  'player.visualizer_mode_hint': 'サウンドの視覚化方法を選べます。',
  'settings.ui_sounds_desc': '通知音、入退室音、タッチ音をオン・オフできます。',
  'settings.reverb_desc': '音の残響と響きを調整します。',
  'settings.eq_desc': '音色を調整します。音量調整と併用してください。',
  ...
  'settings.dark': 'ダーク',
  'settings.light': 'ライト',
  'player.visualizer_circular': '円形',
  'player.visualizer_spectrum': 'スペクトラム',
  ...
  'player.sync_compact': '同期',
  'player.syncing_compact': '同期中…',
  'player.play_media': 'メディア再生',
  'player.play_media_compact': 'メディア',
  ...
  'playlist.delete_selected': '選択したトラック{{count}}件を削除',
  ...
  'connect.administrator_list': '管理者：{{count}}人',
  'connect.room_owner_role': 'ルームオーナー',
  'connect.administrator_role': '管理者',
  'connect.administrator_settings_aria': '{{name}}の管理者権限を設定',
  ...
  'connect.permission_media_add': 'メディアを管理',
  'connect.permission_playback_control': '再生を操作',
  'connect.permission_members_kick': 'メンバーを退出させる',
  'connect.permission_chat_notice': 'チャットにお知らせを投稿',
  'connect.permission_inherited': '基本権限',
  'connect.kick_member_message': '{{name}}として接続中のすべてのデバイスを退出させますか？',
  'connect.device_toggle': '{{name}}の接続デバイスを開閉',
  'connect.device_label': '{{platform}}デバイス（{{code}}）',
  'connect.platform_other': 'その他',
  'connect.current_device': 'このデバイス',
  ...
  'connect.kick_no': 'いいえ',
  'connect.kicked_title': '強制退出',
  'connect.kicked_message': 'ホストによりルームから退出させられました。',
  'connect.copy_invite_link': '招待リンクをコピー',
  'connect.link_copied': '招待リンクをコピーしました',
  'connect.room_password_title': '参加時のパスワードを必須にする',
  'connect.room_password_set': '設定',
  'connect.room_password_toggle_aria': 'ルーム参加時のパスワード要否を切り替える',
  ...
  'connect.room_password_invalid': '8桁の数字を入力してください',
  ...
  'connect.signaling_recovering': '再接続中…',
  'connect.signaling_failed': 'サーバー接続に失敗しました',
  'connect.signaling_recover_action': '再接続',
  ...
  'connect.signaling_restart': 'セッションを再起動',
  'connect.signaling_new_room': '新しいルームを開始',
  ...
  'setup.enter_host_code': '招待コードを入力',
  'setup.enter_host_code_alt': 'QRコードをスキャンするか、招待コードを入力してください。',
  'setup.scan_qr': 'タップしてスキャン',
  ...
  'setup.connect_devices': '別のデバイスでQRをスキャンするか、コードを入力してください。',
  ...
  'youtube.effects_disabled': 'YouTubeを一緒に視聴します。\n高度なオーディオ効果は無効です。',
  ...
  'network.session_full_detail':
    'このルームには、ホストを含め最大100台のデバイスがすでに接続されています。',
  ...
  'share.remote.downloading': 'リモートファイルをダウンロード中...',
  'share.remote.upload_failed': 'リモートファイル共有に失敗しました：{{msg}}',
  'share.remote.download_failed': 'リモートファイルのダウンロードに失敗しました：{{msg}}',
  ...
  'share.remote.rate_limited':
    'リモート共有のアップロードが多すぎます。\nしばらくしてからお試しください',
  'share.remote.quota_reached': 'リモート共有のストレージ上限に達しました',
  ...
  'system_audio.owner_preparing': '{{name}}さんがシステムオーディオ共有の準備をしています。',
  'system_audio.pro_preparing': 'システムオーディオ共有の準備をしています。',
  'system_audio.pro_publish_failed': 'システムオーディオ共有を開始できませんでした。',
  'system_audio.coordinator_update_required':
    'システムオーディオを共有するには、このルームを管理している端末を更新してください。',
  ...
  'toast.added_tracks': 'トラックを{{count}}件追加しました',
  ...
  'toast.op_status': '{{label}}の管理者権限：{{status}}',
  ...
  'toast.virtual_treble_off': 'バーチャルトレブルがオフになりました',
  'toast.virtual_surround_on': 'バーチャルサラウンドがオンになりました',
  'toast.virtual_surround_off': 'バーチャルサラウンドがオフになりました',
  'toast.virtual_effects_off': 'すべてのバーチャルエフェクトがオフになりました',
  ...
  'toast.yt_rendezvous_no_data':
    'ホストの再生データがまだありません。しばらくしてからもう一度お試しください',
  'toast.yt_rendezvous_timeout': '同期に失敗しました。しばらくしてからもう一度お試しください',
  ...
  'error.browser_update': 'ブラウザを最新バージョンに更新してください。',
  'error.load_failed': '読み込みに失敗しました：{{msg}}',
  ...
  'dialog.large_room_file.message':
    '同じネットワークでは、ホストを除くゲスト端末8台まで直接ファイル転送が安定します。より大規模なローカルルームでは、ファイルがCloudflare R2経由で配信される場合があります。\n\n続行しますか？',
  'dialog.continue': '続行',
  'dialog.file_drop.title': 'ローカルファイルを追加',
  'dialog.file_drop.message': '{{count}}個のファイルを追加しますか？',
  'dialog.file_drop.unsupported_notice': '未対応のファイル{{count}}個は追加されません。',
  'dialog.return_home_title': 'ルームから退出',
  ...
  'dialog.continue_using': '続ける',
  'dialog.leave_session': '退出',
  'dialog.sw_update_title': 'アップデート',
  'dialog.sw_update_msg':
    '新しいバージョンの準備ができました。ページを再読み込みするとアップデートが適用されます。',
  ...
  'dialog.session_lost_msg':
    'アプリがスリープしたか接続を失ったため、他のデバイスはすでに切断されています。ページを再読み込みして新しいルームを始めてください。',
  'dialog.session_lost_btn': '再読み込み',
  ...
  'pro.claim_popup_blocked_message':
    'ブラウザによってログイン用のポップアップがブロックされました。MUSIXQUAREのポップアップを許可して、もう一度お試しください。',
  ...
  'pro.claim_failed_message':
    '安全のため、このリンクでの再試行は行われませんでした。ルーム管理者に新しいリンクを依頼してください。',
  ...
  'pro.active_tab_message': 'このタブで続けると、元のタブの接続が終了します。',
  'pro.use_this_tab': 'このタブを使う',
  'pro.upload.batch_progress': 'トラックをアップロード中：{{current}}/{{total}}',
  'pro.upload.batch_failed_title': '一部のトラックをアップロードできませんでした',
  'pro.upload.batch_failed_message':
    'リクエストされた{{total}}曲のうち{{failed}}曲をアップロードできませんでした。',
  'pro.upload.cancel_file': '{{name}}のアップロードをキャンセル',
  'pro.upload.confirming_file': '{{name}}のアップロードを完了しています',
  ...
  'chat.cmd_frozen_blocked': '現在チャットはロックされています',
  ...
  'chat.bot_added_tracks': 'BOTがトラックを{{count}}件追加しました',
  'chat.bot_added_and_playing': 'BOTがトラックを{{count}}件追加して再生を開始しました',
  ...
  'chat.remote_upload_failed_system_message':
    'リモートファイルのアップロードに失敗しました。\nリモート参加者はしばらくしてからもう一度お試しください。',
  'chat.pinned_close': 'お知らせを閉じる',
  'chat.cmd_whisper_from': '{{name}}からの個別メッセージ',
  'chat.cmd_whisper_to': '{{name}}への個別メッセージ',
  'chat.cmd_target_not_found': '対象が見つかりません: {{target}}',
  'chat.cmd_no_permission': 'このコマンドを実行する権限がありません',
  ...
  'chat.cmd_d_freeze': 'チャットをロック',
  'chat.cmd_d_slowmode': 'スローモード',
  'chat.cmd_d_w': '個別メッセージ',
  'chat.cmd_d_notice': 'お知らせ',
  'chat.cmd_d_nick': 'ニックネームを変更',
  'chat.cmd_d_kick': 'デバイスを退出させる',
  'chat.cmd_d_op': '管理者権限を付与',
  'chat.cmd_d_deop': '管理者権限を解除',
  ...
  'chat.tracks_added_named': '{{name}}がトラックを{{count}}件追加しました（{{title}}ほか）',
