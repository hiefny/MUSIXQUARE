...
const th: Record<I18nKey, string> = {
  ...
  'settings.reverb_desc': 'ปรับเสียงก้องและเสียงสะท้อน',
  'settings.eq_desc': 'ปรับโทนเสียง โปรดใช้ร่วมกับการควบคุมระดับเสียง',
  ...
  'pro.upload.batch_progress': 'กำลังอัปโหลดแทร็ก {{current}}/{{total}}',
