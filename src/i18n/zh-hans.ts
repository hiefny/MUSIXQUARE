...
const zhHans: Record<I18nKey, string> = {
  ...
  'connect.signaling_recover_action': '恢复服务器连接',
  ...
  'pro.use_this_tab': '强制继续',
  'pro.uploading': '正在保存到 PRO 房间...',
  'pro.upload.waiting': '等待上传...',
  'pro.upload.progress': '正在上传 · {{percent}}%',
  'pro.upload.confirming': '正在 PRO 房间中确认...',
  'pro.upload.completed': '已添加到播放列表',
  'pro.upload.failed': '上传失败',
  'pro.upload.retry': '重试',
  'pro.upload.remove': '移除',
  'pro.upload.cancel_file': '取消上传 {{name}}',
  'pro.upload.retry_file': '重试上传 {{name}}',
  'pro.upload.remove_file': '移除失败的 {{name}} 上传',
