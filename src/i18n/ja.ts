...
const ja: Record<I18nKey, string> = {
  ...
  'account.login_cancelled': 'ログインをキャンセルしました。',
  ...
  'account.stats_listening_label': '視聴時間',
  ...
  'settings.virtual_effects_desc': '合成技術を音声に適用します。強く歪むことがあります。',
  ...
  'connect.signaling_restart': 'セッションを再開',
